                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/eur.svg') }}" alt="" class="avatar-xxs me-2 material-shadow">
                                    EUR
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/gbp.svg') }}" alt="" class="avatar-xxs me-2 material-shadow">
                                    GBP
                                </div>
                            </td>
                            <td class="form_name">Wallet</td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/jpy.svg') }}" alt="" class="avatar-xxs me-2 material-shadow">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/xpm.svg') }}" alt="" class="avatar-xxs me-2 material-shadow">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/ppt.svg') }}" alt="" class="avatar-xxs me-2 material-shadow">
                                    PPT
                                </div>
                            </td>
