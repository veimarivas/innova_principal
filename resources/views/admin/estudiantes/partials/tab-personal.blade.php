...
<div class="est-tabs-body active est-ci-wrap" id="tab-personal">
    ...
    <div class="est-ci-body">
        ...
        {{-- ── Columna izquierda: foto + quick data ─────────── --}}
        <div class="est-ci-left">
            ...
            <div class="pers-acc-chips">
                <div class="pers-acc-chip {{ $tieneSistemaCuenta ? 'pers-chip-ok' : 'pers-chip-no' }}">
                    <i class="{{ $tieneSistemaCuenta ? 'ri-computer-line' : 'ri-computer-line' }}"></i>
                    <span>Sistema{{ $tieneSistemaCuenta ? ': Activo' : ': Sin cuenta' }}</span>
                </div>
                <div class="pers-acc-chip {{ $tieneMoodleCuenta ? 'pers-chip-ok' : 'pers-chip-no' }}">
                    <i class="ri-links-line"></i>
                    <span>Moodle{{ $tieneMoodleCuenta ? ': Activo' : ': Sin cuenta' }}</span>
                </div>
            </div>
        </div>

        {{-- ── Columna central: nombre + contacto ───────────── --}}
        <div class="est-ci-center">
            ...
            <div class="pers-contact-row">
                ...
                <div class="pers-contact-body">
                    ...
                    <div class="pers-contact-val">
                        <a href="mailto:{{ $persona->correo }}" class="pers-contact-link">{{ $persona->correo }}</a>
                    </div>
                </div>
                <a href="mailto:{{ $persona->correo }}" class="pers-contact-act" title="Enviar correo">
            ...
            <div class="pers-contact-row">
                ...
                <div class="pers-contact-body">
                    ...
                    <div class="pers-contact-val">
                        <a href="tel:{{ $persona->celular }}" class="pers-contact-link">{{ $persona->celular }}</a>
                    </div>
                </div>
                <a href="https://wa.me/{{ preg_replace('/\D/', '', $persona->celular) }}"
            ...
            @if($persona?->estado_civil || $persona?->fecha_nacimiento)
            <div class="pers-inline-grid" style="margin-top:6px;">
                ...
                <div class="pers-inline-item">
                    ...
                    <span class="est-ci-value">
                        ...
                        @if($edad)<span style="color:#94a3b8;font-size:.78rem;font-weight:500;"> · {{ $edad }} años</span>@endif
                    </span>
                </div>
                @endif
            </div>
        ...
        {{-- ── Columna derecha: datos académicos + estudios ─── --}}
        <div class="est-ci-right">
            ...
            <div style="display:flex;flex-direction:column;gap:6px;overflow-y:auto;max-height:220px;padding-right:2px;">
                ...
                <div class="pers-study-card">
                    @if($est->grado_academico?->nombre)
                    <span class="pers-study-grado">
                        <i class="ri-award-line"></i>
                        {{ $est->grado_academico->nombre }}
                    </span>
                    @endif
                    <div class="pers-study-profesion">
                        {{ $est->profesion?->nombre ?? '—' }}
                    </div>
                    @if($est->universidad?->nombre)
