        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center px-4 py-3">
                ...
                <p id="tv-mensaje" style="font-size:.82rem;color:#6b7280;margin-bottom:0;">
                    El estudiante podrá ingresar al portal virtual nuevamente.
                </p>
            </div>
...
(function () {
                ...
                },
                {
                    ...
                    render: d => {
                        ...
                        if (d.tiene_usuario && d.usuario_id) {
                            ...
                            if (tieneVirtual) {
                                btns += '<button type="button" class="est-btn-action btn-toggle-virtual"'
    ...
    function bindEvents() {
        ...
        // Toggle acceso virtual (habilitar / deshabilitar) desde estudiantes
        $(document).on('click', '.btn-toggle-virtual', function (e) {
            ...
            if (esVirtualAhora) {
                ...
                let msg = 'El estudiante ya no podrá ingresar al portal virtual.';
                if (accesoAdmin) {
                ...
                let msg = 'El estudiante podrá ingresar al portal virtual nuevamente.';
                if (accesoAdmin) {
