        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius:18px;overflow:hidden;">
            ...
            <div class="modal-body p-0">
                <div class="row g-0">
                    ...
                    {{-- Columna izquierda: info académica --}}
                    ...
                    {{-- Columna derecha: gestión interactiva --}}
        ...
        <div class="modal-content" style="border:none;border-radius:18px;overflow:hidden;box-shadow:0 25px 60px rgba(0,0,0,.2);">
            ...
            <div class="modal-body" style="padding:0;">
                ...
                <div style="padding:1.1rem 1.5rem;border-bottom:1px solid #f1f5f9;">
                    <div style="display:flex;align-items:center;gap:.5rem;margin-bottom:.85rem;">
                        <div style="width:26px;height:26px;border-radius:7px;background:rgba(252,123,4,.12);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            <i class="ri-bar-chart-2-line" style="color:{{ $brandColor }};font-size:.85rem;"></i>
                        </div>
                        <span style="font-size:.7rem;font-weight:800;text-transform:uppercase;letter-spacing:.07em;color:{{ $brandColor }};">Resumen de Sesiones</span>
                    </div>
                    <div class="row g-3">
                        <div class="col-4">
                    ...
                    <div id="asigHorarioBannerPeriodo" style="display:none;margin-top:.85rem;padding:.6rem .9rem;background:rgba(252,123,4,.05);border:1px dashed rgba(252,123,4,.3);border-radius:10px;">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            <i class="ri-calendar-2-line" style="color:{{ $brandColor }};font-size:.85rem;flex-shrink:0;"></i>
                            ...
                            <span style="display:inline-flex;align-items:center;gap:.25rem;font-size:.77rem;font-weight:600;color:#1e293b;background:white;padding:.12rem .55rem;border-radius:20px;border:1px solid #e2e8f0;">
                                <i class="ri-play-circle-line" style="color:{{ $brandColor }};font-size:.75rem;"></i>
                            ...
                            {{-- Mantener IDs ocultos para compatibilidad JS --}}
                ...
                <div style="padding:1.1rem 1.5rem;border-bottom:1px solid #f1f5f9;">
                    ...
                    {{-- Botón Todas oculto, mantenido para compatibilidad JS --}}
                    ...
                    <div>
                        ...
                        <div class="input-group" style="border-radius:9px;overflow:hidden;">
                            ...
                            <button type="button" class="btn" id="btnBuscarTrabajador"
                                style="background:{{ $brandColor }};border:none;color:#fff;padding:.4rem .85rem;border-radius:0 9px 9px 0;font-size:.85rem;">
            ...
            <div class="modal-footer" style="border-top:1px solid #e2e8f0;padding:1rem 1.5rem;background:#f8fafc;gap:.5rem;">
                ...
                <button type="button" class="btn btn-sm" id="btnGuardarAsignarHorario"
                    style="background:linear-gradient(135deg,#391b04,{{ $brandColor }});border:none;color:white;border-radius:8px;font-size:.82rem;padding:.4rem 1.15rem;font-weight:700;box-shadow:0 4px 12px rgba(252,123,4,.3);transition:all .2s;">
            ...
            <div class="modal-body" style="padding:1.5rem;">
                ...
                <div class="mb-3">
                    <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                        <i class="ri-text" style="color:{{ $brandColor }};"></i> Nombre del Módulo <span style="color:#ef4444;">*</span>
                    </label>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                            <i class="ri-play-circle-line" style="color:{{ $brandColor }};"></i> Fecha Inicio
                        </label>
                ...
                <div class="mb-4">
                    <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                        <i class="ri-palette-line" style="color:{{ $brandColor }};"></i> Color Identificador
                    </label>
...
<div class="modal fade" id="modalConfirmarRegistroDocente" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:420px;">
        <div class="modal-content" style="border:none;border-radius:16px;overflow:hidden;box-shadow:0 20px 50px rgba(0,0,0,.2);">
            ...
            {{-- Header --}}
            <div class="modal-header" style="background:linear-gradient(135deg,#391b04,#7c3c00,{{ $brandColor }});color:white;padding:1.1rem 1.4rem;border:none;">
                <div class="d-flex align-items-center gap-3">
            ...
            <div class="modal-footer" style="padding:.9rem 1.4rem;gap:.5rem;border-top:1px solid #f1f5f9;background:#f8fafc;">
                ...
                <button type="button" id="btnConfirmarRegistroDocente"
                    style="padding:.4rem 1.1rem;background:linear-gradient(135deg,#391b04,{{ $brandColor }});border:none;border-radius:8px;color:#fff;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem;box-shadow:0 3px 10px rgba(252,123,4,.3);transition:all .2s;">
        ...
        <div class="modal-content" style="border:none;border-radius:18px;overflow:hidden;box-shadow:0 25px 60px rgba(0,0,0,.2);">
            ...
            <div class="modal-footer" style="border-top:1px solid #e2e8f0;padding:1rem 1.5rem;background:#f8fafc;gap:.5rem;">
                ...
                <button type="button" id="btnRegistrarYAsignarDocente"
                    style="padding:.4rem 1.15rem;background:linear-gradient(135deg,#391b04,{{ $brandColor }});border:none;border-radius:8px;color:#fff;font-size:.82rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem;box-shadow:0 4px 12px rgba(252,123,4,.3);transition:all .2s;">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:420px;">
        <div class="modal-content" style="border:none;border-radius:16px;overflow:hidden;box-shadow:0 20px 50px rgba(0,0,0,.18);">
            ...
            <div class="modal-body" style="padding:1.25rem;">
                ...
                {{-- Campo: nueva fecha (solo Postergado) --}}
                ...
                {{-- Campo: enlace de grabación (solo Desarrollado) --}}
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:500px;">
        <div class="modal-content" style="border:none;border-radius:16px;overflow:hidden;box-shadow:0 25px 60px rgba(0,0,0,.18);">
            ...
            <div class="modal-body" style="padding:1.5rem;">
                ...
                {{-- Selector de cuenta (oculto si solo hay 1) --}}
                <div class="mb-3" id="enlaceVidCuentaWrap">
                    <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                        <i class="ri-computer-line" style="color:{{ $brandColor }};"></i> Cuenta de Videollamada <span style="color:#ef4444;">*</span>
                    </label>
                ...
                <div class="mb-3">
                    <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                        <i class="ri-text" style="color:{{ $brandColor }};"></i> Nombre del Enlace <span style="color:#ef4444;">*</span>
                    </label>
                ...
                <div class="mb-1">
                    <label style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#878a99;display:flex;align-items:center;gap:.35rem;margin-bottom:.5rem;">
                        <i class="ri-link" style="color:{{ $brandColor }};"></i> Enlace de la Sesión <span style="color:#ef4444;">*</span>
                    </label>
            ...
            <div class="modal-footer" style="border-top:1px solid #e2e8f0;padding:1rem 1.5rem;background:#f8fafc;gap:.5rem;">
                ...
                <button type="button" id="btnGuardarEnlaceVid"
                    style="background:linear-gradient(135deg,#391b04,{{ $brandColor }});border:none;color:white;border-radius:8px;font-size:.82rem;padding:.4rem 1.15rem;font-weight:700;box-shadow:0 4px 12px rgba(252,123,4,.3);transition:all .2s;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem;">
...
{{-- ═══════════════════════════════════════════════════════
     Modal: Editar Responsables (Información General)
══════════════════════════════════════════════════════════ --}}
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:520px;">
        <div class="modal-content" style="border-radius:14px;border:none;box-shadow:0 10px 40px rgba(0,0,0,.15);">
            ...
            <div class="modal-body" style="padding:1.4rem;">
                <input type="hidden" id="respAcademicoId" value="{{ $oferta->responsable_academico_id ?? '' }}">
                <input type="hidden" id="respMarketingId" value="{{ $oferta->responsable_marketing_id ?? '' }}">
                ...
                <div class="mb-1">
                    ...
                    <div id="respMarketingActual" style="display:none;margin-bottom:.6rem;padding:.55rem .75rem;background:rgba(var(--brand-color-rgb),.06);border:1px solid rgba(var(--brand-color-rgb),.2);border-radius:8px;align-items:center;justify-content:space-between;gap:.5rem;">
                        <div style="display:flex;align-items:center;gap:.5rem;min-width:0;">
                            <div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,{{ $brandColor }},#c96004);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                <i class="ri-user-line" style="color:#fff;font-size:.8rem;"></i>
                            </div>
                            <div style="min-width:0;">
...
{{-- ═══════════════════════════════════════════════════════
     Modal: Gestionar Documentos (Información General) — ambos
══════════════════════════════════════════════════════════ --}}
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.6rem;">
                            ...
                            @if($oferta->portada)
                                <span style="font-size:.68rem;color:#16a34a;display:flex;align-items:center;gap:.3rem;">
                                    ...
                                    <a href="{{ asset('storage/' . $oferta->portada) }}" target="_blank"
                    ...
                    <div class="mb-1">
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.6rem;">
                            ...
                            @if($oferta->certificado)
                                <span style="font-size:.68rem;color:#16a34a;display:flex;align-items:center;gap:.3rem;">
                                    <i class="ri-checkbox-circle-fill"></i> Actual:
                                    <a href="{{ asset('storage/' . $oferta->certificado) }}" target="_blank"
                                       style="color:#16a34a;text-decoration:underline;">ver archivo</a>
                                </span>
                            @else
...
{{-- ═══════════════════════════════════════════════════════
     Modal: Editar Documento Individual (portada o certificado)
══════════════════════════════════════════════════════════ --}}
