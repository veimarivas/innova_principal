                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/eth.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/xmr.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/mkr.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('build/images/svg/crypto-icons/neo.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/btc.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/eth.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/xrp.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/xmr.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/ltc.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/aave.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/mkr.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/yfi.svg') }}" alt="" class="avatar-xxs me-2 material-shadow" />
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('build/images/svg/crypto-icons/xmr.svg') }}" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('build/images/svg/crypto-icons/fil.svg') }}" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('build/images/svg/crypto-icons/dot.svg') }}" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
