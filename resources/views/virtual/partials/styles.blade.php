...
.moodle-date-row.vencido b { color: #dc3545; }
.moodle-date-tag {
...
.moodle-date-tag.late   { background: rgba(220,53,69,.12); color: #dc3545; }
.moodle-date-tag.future { background: rgba(108,117,125,.1); color: #6c757d; }
