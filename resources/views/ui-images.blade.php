                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded material-shadow" alt="200x200" width="200" src="{{ URL::asset('build/images/small/img-4.jpg') }}" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img class="rounded-circle avatar-xl material-shadow" alt="200x200" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" data-holder-rendered="true">
                                </div>
                            </div><!-- end col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded avatar-xxs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-10.jpg') }}" alt="" class="rounded avatar-xs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="rounded avatar-sm material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="rounded avatar-md material-shadow">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="rounded avatar-lg material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded avatar-xl material-shadow">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 mt-5">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xs material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-sm material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-md material-shadow">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-lg material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xl material-shadow">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xl</code></p>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
