            ...
            <div class="{{ $tipoGridClass }}">
                @forelse($tipos as $tipo)
                    <div class="type-card">
                        ...
                        <h3>{{ $tipo->nombre }}</h3>
                        <p>{{ $tipo->descripcion ?? 'Programa de formación especializada diseñado para potenciar tu perfil profesional con alto estándar académico.' }}
                        </p>
...
@forelse($ofertas as $oferta)
                    ...
                    <div class="prog-card" data-sede="{{ $sedeSlug }}">
                        ...
                        <div class="prog-body">
                            ...
                            <h3 class="prog-title">
                                {{ optional($oferta->programa)->nombre ?? (optional($oferta->posgrado)->nombre ?? 'Programa sin nombre') }}
                            </h3>
                            <p class="prog-desc">
                                {{ Str::limit(optional($oferta->posgrado)->objetivo ?? 'Información disponible próximamente.', 110) }}
                            </p>
                            <div class="prog-meta">
                            ...
                            <div class="prog-footer">
                                <div class="prog-price">
                                    @if ($precio > 0)
                                        ...
                                        <small>{{ $primerPlanNombre ?: 'Precio total' }}</small>
                                    @else
                                        <span
                                ...
                                <a href="{{ route('oferta.detalle', $oferta->id) }}" class="btn-primary"
                                        ...
                                        <div class="team-card">
                                            <div class="team-img">
                                                ...
                                                @if ($trabajador->persona->fotografia)
                                                    <img src="{{ asset('images/personas/' . $trabajador->persona->fotografia) }}"
                                            ...
                                            <div class="team-info">
                                                ...
                                                <div class="team-sede">
                                                    <i class="fas fa-map-marker-alt"></i>
                                                    @if ($cp->sucursale)
                                                        {{ optional($cp->sucursale->sede)->nombre }} —
                                                        {{ $cp->sucursale->nombre }}
                                                    @else
                                                ...
                                                <div class="team-contacts">
                                                    @if ($trabajador->persona->correo)
                                                        <a href="mailto:{{ $trabajador->persona->correo }}"
                                                            class="tcb tcb-email"
                                                            title="{{ $trabajador->persona->correo }}">
                                                    ...
                                                    @if ($trabajador->persona->celular)
                                                        <a href="https://wa.me/591{{ $trabajador->persona->celular }}"
                                                            ...
                                                            title="{{ $trabajador->persona->celular }}">
                ...
                <div class="partners-grid">
                    ...
                    <div class="partners-right">
                        @foreach ($convenios as $c)
                            <div class="partner-logo-card" title="{{ $c->nombre }}">
                                <img src="{{ asset('storage/' . $c->imagen) }}" alt="{{ $c->nombre }}"
                                    onerror="this.style.display='none';this.nextElementSibling.style.display='block'">
                                <span class="fallback-text" style="display:none;">{{ $c->nombre }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <section class="sedes-section" id="sedes">
            <div class="container">
                ...
                @if ($sucursales->count() === 1)
                    @php $sucursal = $sucursales->first(); @endphp
                    <div class="sede-showcase">
                        <div class="sede-showcase-map">
                            <iframe
                                src="https://www.google.com/maps/embed/v1/place?key=TU_API_KEY&q={{ $sucursal->latitud }},{{ $sucursal->longitud }}"
                                allowfullscreen loading="lazy">
                            </iframe>
                        </div>
                        <div class="sede-showcase-info">
                            @if ($sucursal->sede)
                                <div class="sede-showcase-parent">{{ $sucursal->sede->nombre }}</div>
                            @endif
                            <h3 class="sede-showcase-name">{{ $sucursal->nombre }}</h3>
                            ...
                            <div class="sede-showcase-stats">
                                <div class="sede-showcase-stat">
                                    <span
                                        class="sede-showcase-stat-num">{{ $sucursal->ofertas_academicas()->count() }}</span>
                        ...
                        <div class="sede-track-wrap" id="sedeWrap">
                            <div class="sede-track" id="sedeTrack">
                                @foreach ($sucursales as $sucursal)
                                    <div class="sede-card"
                                        data-sede="{{ strtolower(str_replace(' ', '', $sucursal->nombre)) }}">
                                        <div class="sede-map">
                                        ...
                                        <div class="sede-info">
                                            ...
                                            <div class="sede-stats">
                                                <div class="sede-stat">
                                                    <span
                                                        class="sede-stat-num">{{ $sucursal->ofertas_academicas()->count() }}</span>
