    ...
    <div class="container-fluid py-4">
        ...
        <div class="est-header">
            <div>
                ...
                <p><?php echo e($persona->nombres ?? ''); ?> <?php echo e($persona->apellido_paterno ?? ''); ?>

                    <?php echo e($persona->apellido_materno ?? ''); ?></p>
            </div>
            <div class="est-header-actions">
                <a href="<?php echo e(route('admin.estudiantes.index')); ?>" class="est-header-btn"><i class="ri-arrow-left-line"></i>
                    Volver</a>
            </div>
        </div>

        <div class="est-tabs-card">
            <?php echo $__env->make('admin.estudiantes.partials.tabs-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.estudiantes.partials.tab-personal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.estudiantes.partials.tab-documentos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.estudiantes.partials.tab-academico', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.estudiantes.partials.tab-contable', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="estudioTipo" style="border-radius: 8px;">
                                ...
                                <?php $__currentLoopData = $tiposEstudio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="estudioProfesion" style="border-radius: 8px;">
                                <option value="">Seleccionar...</option>
                                <?php $__currentLoopData = $profesiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($prof->id); ?>"><?php echo e($prof->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="estudioUniversidad" style="border-radius: 8px;">
                                ...
                                <?php $__currentLoopData = $universidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($uni->id); ?>"><?php echo e($uni->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (data.data && data.data.pago_id) {
                            ...
                            setTimeout(() => {
                                const estudianteId = '<?php echo e($estudiante->id); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/estudiantes/detalle.blade.php ENDPATH**/ ?>