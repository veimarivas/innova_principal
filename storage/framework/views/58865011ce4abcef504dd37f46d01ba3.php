<?php $__env->startSection('title', 'Cuenta – ' . $cuenta->nombre); ?>
...
<div class="cv-page">
    ...
    <div class="cv-hero">
        <div class="cv-hero-left">
            <div class="cv-hero-avatar"><i class="<?php echo e($platformIcon); ?>"></i></div>
            <div style="min-width:0;">
                <p class="cv-hero-pre">Cuenta de videollamada</p>
                <h1 class="cv-hero-name"><?php echo e($cuenta->nombre); ?></h1>
                <div class="cv-hero-meta">
                    <span class="cv-hero-chip">
                        <i class="<?php echo e($platformIcon); ?>"></i><?php echo e($cuenta->plataforma); ?>

                    </span>
                    <span class="cv-hero-chip <?php echo e($cuenta->activo ? 'ok' : 'off'); ?>">
                        <i class="<?php echo e($cuenta->activo ? 'ri-checkbox-circle-fill' : 'ri-close-circle-line'); ?>"></i>
                        <?php echo e($cuenta->activo ? 'Activa' : 'Inactiva'); ?>

                    </span>
                    <?php if($cuenta->created_at): ?>
                    <span>
                        <i class="ri-calendar-line"></i>
                        Registrada el <?php echo e($cuenta->created_at->format('d/m/Y')); ?>
        ...
        <div class="cv-hero-right">
            <a href="<?php echo e(route('admin.cuentas-videollamada.index')); ?>" class="cv-back">
    ...
    <div class="row g-3 mb-3">
        <div class="col-6 col-lg-3">
            <div class="cv-stat">
                ...
                <div>
                    <div class="cv-stat-num"><?php echo e($totalEnlaces); ?></div>
                    <div class="cv-stat-lbl"><?php echo e($totalEnlaces === 1 ? 'Enlace' : 'Enlaces'); ?></div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="cv-stat">
                ...
                <div>
                    <div class="cv-stat-num"><?php echo e($totalSesiones); ?></div>
                    <div class="cv-stat-lbl"><?php echo e($totalSesiones === 1 ? 'Sesión total' : 'Sesiones totales'); ?></div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="cv-stat">
                ...
                <div>
                    <div class="cv-stat-num"><?php echo e($conGrab); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="cv-stat">
                ...
                <div>
                    <div class="cv-stat-num"><?php echo e($sinGrab); ?></div>
    ...
    <div class="cv-card">
        ...
        <div class="cv-tabs-nav">
            ...
            <button class="cv-tab-btn" data-tab="enlaces">
                ...
                <span class="cv-tab-count"><?php echo e($totalEnlaces); ?></span>
            </button>
        </div>
            ...
            <div class="cv-info-grid">
                ...
                <div class="cv-icard">
                    ...
                    <div class="cv-field">
                        ...
                        <div>
                            ...
                            <div class="cv-field-val"><?php echo e($cuenta->nombre); ?></div>
                        </div>
                    </div>
                    <div class="cv-field">
                        <div class="cv-field-ico"><i class="<?php echo e($platformIcon); ?>"></i></div>
                        <div>
                            <div class="cv-field-lbl">Plataforma</div>
                            <div class="cv-field-val"><?php echo e($cuenta->plataforma); ?></div>
                        </div>
                    </div>
                    <div class="cv-field">
                        <div class="cv-field-ico">
                            <i class="<?php echo e($cuenta->activo ? 'ri-toggle-line' : 'ri-toggle-fill'); ?>"
                               style="color:<?php echo e($cuenta->activo ? 'var(--cv-ok)' : 'var(--cv-muted)'); ?>;"></i>
                        </div>
                        <div>
                    ...
                    <div class="cv-field">
                        ...
                        <div>
                            ...
                            <div class="cv-field-val">#<?php echo e($cuenta->id); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cv-icard">
                    ...
                    <div class="cv-mini">
                        ...
                        <div style="flex:1;">
                            <div class="cv-mini-num"><?php echo e($totalEnlaces); ?></div>
                            <div class="cv-mini-lbl"><?php echo e($totalEnlaces === 1 ? 'Enlace registrado' : 'Enlaces registrados'); ?></div>
                        </div>
                    </div>
                    <div class="cv-mini">
                        ...
                        <div style="flex:1;">
                            <div class="cv-mini-num"><?php echo e($totalSesiones); ?></div>
                            <div class="cv-mini-lbl"><?php echo e($totalSesiones === 1 ? 'Sesión asociada' : 'Sesiones asociadas'); ?></div>
                        </div>
                    </div>
                    <div class="cv-mini">
                        ...
                        <div style="flex:1;min-width:0;">
                            <div class="cv-mini-num"><?php echo e($pctGrab); ?>%</div>
                            <div class="cv-mini-lbl">Sesiones con grabación (<?php echo e($conGrab); ?>/<?php echo e($totalSesiones); ?>)</div>
                            <div class="cv-mini-prog">
                                <div class="cv-mini-prog-fill" style="width:<?php echo e($pctGrab); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cv-icard">
                    ...
                    <div class="cv-field">
                        ...
                        <div>
                            ...
                            <?php if($cuenta->created_at): ?>
                                <div class="cv-field-val"><?php echo e($cuenta->created_at->format('d/m/Y')); ?></div>
                                <div class="cv-field-sub"><?php echo e($cuenta->created_at->format('H:i')); ?> hrs</div>
                            <?php else: ?>
                    ...
                    <div class="cv-field">
                        ...
                        <div>
                            ...
                            <?php if($cuenta->updated_at): ?>
                                <div class="cv-field-val"><?php echo e($cuenta->updated_at->format('d/m/Y')); ?></div>
                                <div class="cv-field-sub"><?php echo e($cuenta->updated_at->format('H:i')); ?> hrs</div>
                            <?php else: ?>
                                <div class="cv-field-val dim">—</div>
                            <?php endif; ?>
                        </div>
        ...
        <div class="cv-tab-body" id="tab-enlaces">
            ...
            <?php else: ?>
                <div class="cv-acc-list">
                    <?php $__currentLoopData = $cuenta->enlaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enlace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                    <div class="cv-acc <?php echo e($loop->first ? 'open' : ''); ?>" id="<?php echo e($enlaceId); ?>">

                        
                        <button class="cv-acc-toggle" type="button" data-acc="<?php echo e($enlaceId); ?>">
                            <div class="cv-acc-icon"><i class="ri-link"></i></div>
                            <div class="cv-acc-info">
                                <div class="cv-acc-name"><?php echo e($enlace->nombre); ?></div>
                                <div class="cv-acc-url-preview">
                                    <i class="ri-global-line" style="flex-shrink:0;"></i>
                                    <span><?php echo e($enlace->enlace); ?></span>
                                </div>
                            </div>
                            <div class="cv-acc-meta">
                                ...
                                <div class="cv-prog">
                                    <div class="cv-prog-bar">
                                        <div class="cv-prog-fill" style="width:<?php echo e($pct); ?>%;"></div>
                                    </div>
                                    <span class="cv-prog-txt"><?php echo e($grabCount); ?>/<?php echo e($sesCount); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php if($grabCount > 0): ?>
                                <span class="cv-chip cv-chip-rec">
                                    <i class="ri-record-circle-line"></i>
                                    <?php echo e($grabCount); ?> grabación<?php echo e($grabCount > 1 ? 'es' : ''); ?>

                                </span>
                                <?php endif; ?>
                                <span class="cv-chip cv-chip-gray">
                                    <i class="ri-calendar-line"></i>
                                    <?php echo e($sesCount); ?> sesión<?php echo e($sesCount !== 1 ? 'es' : ''); ?>
                        ...
                        <div class="cv-acc-body">
                            ...
                            <div class="cv-url-bar">
                                ...
                                <span class="cv-url-txt"><?php echo e($enlace->enlace); ?></span>
                                <div class="cv-url-actions">
                                    <span class="cv-copied" id="tip-<?php echo e($enlace->id); ?>">
                                        <i class="ri-check-line"></i> ¡Copiado!
                                    </span>
                                    <button class="cv-btn-sm cv-btn-copy"
                                            onclick="cvCopy(<?php echo e($enlace->id); ?>, '<?php echo e(addslashes($enlace->enlace)); ?>')">
                                        <i class="ri-file-copy-line"></i> Copiar URL
                                    </button>
                                    <a href="<?php echo e($enlace->enlace); ?>" target="_blank" rel="noopener"
                                ...
                                <div class="cv-filter-bar">
                                    <div class="cv-filter-wrap">
                                        ...
                                        <input type="text" class="cv-filter-input"
                                               ...
                                               data-table="<?php echo e($enlace->id); ?>"
                                               oninput="cvFilter(this)">
                                    </div>
                                    <span class="cv-filter-stats" id="fst-<?php echo e($enlace->id); ?>">
                                        <?php echo e($sesCount); ?> <?php echo e($sesCount === 1 ? 'sesión' : 'sesiones'); ?>

                                    </span>
                                </div>

                                <div class="table-responsive">
                                    <table class="cv-table" id="tbl-<?php echo e($enlace->id); ?>">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $sesiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            ?>
                                            <tr class="<?php echo e($hasRec ? 'has-rec' : ''); ?>"
                                                data-search="<?php echo e($search); ?>">
                                                <td class="cv-row-num"><?php echo e($idx + 1); ?></td>
                                                <td>
                                                    <?php if($mNom): ?>
                                                        <div class="cv-mod-name"><?php echo e($mNom); ?></div>
                                                        <?php if($mNum): ?>
                                                            <div class="cv-mod-num">Módulo <?php echo e($mNum); ?></div>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <span style="color:var(--cv-muted);">—</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td style="white-space:nowrap;"><?php echo e($fecha); ?></td>
                                                <td style="white-space:nowrap;">
                                                    <?php if($hi && $hf): ?>
                                                        <?php echo e($hi); ?><span style="color:var(--cv-muted);margin:0 3px;">–</span><?php echo e($hf); ?>

                                                    <?php else: ?> —
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <span class="cv-state <?php echo e($validEs ? $est : 'default'); ?>">
                                                ...
                                                <td>
                                                    <?php if($hasRec): ?>
                                                        <a href="<?php echo e($h->enlace_grabacion); ?>"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/cuentas-videollamada/ver.blade.php ENDPATH**/ ?>