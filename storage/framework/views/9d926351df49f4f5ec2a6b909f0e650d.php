                        ...
                        <div class="posg-fields-3 posg-mb">
                            <div>
                                ...
                                <select class="form-select" id="ofertaFase" disabled>
                                    <option value="">Seleccionar...</option>
                                    <?php $__currentLoopData = $fases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                ...
                                <select class="form-select" id="ofertaModalidad">
                                    <option value="">Seleccionar...</option>
                                    <?php $__currentLoopData = $modalidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        (function() {
                ...
                function initDataTable() {
                    tabla = $('#tabla-posgrads').DataTable({
                        ajax: {
                            url: '<?php echo e(route('admin.posgrads.listar')); ?>',
                            dataSrc: 'data',
                            error: function(xhr) {
                ...
                function populateSelects() {
                    $.when(
                        $.get('<?php echo e(route('admin.areas.listar')); ?>'),
                        $.get('<?php echo e(route('admin.tipos.listar')); ?>')
                ...
                function bindEvents() {
                    ...
                    $('#btnGuardarQuickArea').on('click', function() {
                        ...
                        $.post('<?php echo e(route('admin.areas.guardar')); ?>', {
                                _token: CSRF,
                                nombre: nombre
                            })
                            .done(function(r) {
                    ...
                    const programasData = <?php echo json_encode($programas, 15, 512) ?>;
                    const trabajadoresAcademicosData = <?php echo json_encode($trabajadoresAcademicosData, 15, 512) ?>;
                    const trabajadoresMarketingData = <?php echo json_encode($trabajadoresMarketingData, 15, 512) ?>;
                    const fasesData = <?php echo json_encode($fases, 15, 512) ?>;
                    ...
                    function checkOfertaPrograma() {
                        ...
                        timeoutOfertaPrograma = setTimeout(() => {
                            $.ajax({
                                url: '<?php echo e(route('admin.posgrads.ofertas.verificar-programa')); ?>',
                                type: 'POST',
                                data: {
                                    _token: CSRF,
                    ...
                    function getOrCreatePrograma(nombre) {
                        ...
                        return $.post('<?php echo e(route('admin.programas.guardar')); ?>', {
                            _token: CSRF,
                            nombre: nombre
                        }).then(function(r) {
                            programasData.push({
                            ...
                            getOrCreatePrograma(programaNombre).done(function(progResult) {
                                ...
                                $.ajax({
                                        url: isEdit ? '/admin/posgrads/ofertas/' + id :
                                            '<?php echo e(route('admin.posgrads.ofertas.guardar')); ?>',
                                        type: 'POST',
                                        data: formData,
                                        processData: false,
                                        contentType: false,
                    ...
                    function verificarNombre(inputId, iconId, fbId, idPosgrado, btnId) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('admin.posgrads.verificar')); ?>',
                            type: 'POST',
                            data: {
                                _token: CSRF,
                                nombre: val,
                    ...
                    function guardar() {
                        ...
                        $.ajax({
                                url: '<?php echo e(route('admin.posgrads.guardar')); ?>',
                                type: 'POST',
                                data: {
                                    _token: CSRF,
    ...
    <script>
        (function() {
            ...
            $('#btnConfirmarDocente').on('click', function() {
                ...
                $.ajax({
                        url: '<?php echo e(route('admin.posgrads.modulos.registrar-docente')); ?>',
                        type: 'POST',
                        data: {
                            _token: CSRF,
            ...
            $('#btnGuardarPersonaDocente').on('click', function() {
                ...
                $.ajax({
                        url: '<?php echo e(route('admin.posgrads.modulos.registrar-persona-docente')); ?>',
                        type: 'POST',
                        data: {
                            _token: CSRF,
                            carnet: carnet,
            ...
            $('#btnGuardarModulos').on('click', function() {
                ...
                $.ajax({
                        url: '<?php echo e(route('admin.posgrads.modulos.guardar-batch')); ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            _token: CSRF,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/posgrados/index.blade.php ENDPATH**/ ?>