    ...
    <div class="tab-section-header">
        ...
        <div class="tab-section-stats">
            <div class="tab-section-stat">
                <span class="tab-stat-value"><?php echo e($oferta->n_modulos); ?></span>
                <span class="tab-stat-label">Módulos</span>
            </div>
            <div class="tab-section-stat">
                <span class="tab-stat-value"><?php echo e($oferta->cantidad_sesiones); ?></span>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/ofertas-academicas/partials/ofertas-detalle/tab-modulos.blade.php ENDPATH**/ ?>