<?php $__env->startSection('title'); ?> Universidades <?php $__env->stopSection(); ?>
...
(function () {
    ...
    function initDataTable() {
        tabla = $('#tabla-universidades').DataTable({
            ajax: { url: '<?php echo e(route("admin.universidades.listar")); ?>', dataSrc: 'data' },
            ordering: true,
            paging: false,
            info: false,
            columns: [
    ...
    function verificarNombre(inputId, iconId, fbId, idUniversidade, btnId) {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.universidades.verificar")); ?>',
            type: 'POST',
            data: { 
                _token: CSRF, 
                nombre: val,
    ...
    function guardar() {
        ...
        $.post('<?php echo e(route("admin.universidades.guardar")); ?>', {
            _token: CSRF,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/universidades/index.blade.php ENDPATH**/ ?>