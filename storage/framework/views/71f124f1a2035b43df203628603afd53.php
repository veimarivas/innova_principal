...
<head>
    ...
    <title>Pre-inscripción — <?php echo e(optional($oferta->programa)->nombre ?? 'Programa'); ?> — Innova Ciencia Virtual</title>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <h1 class="hero-title">
                <?php echo e(optional($oferta->programa)->nombre ?? 'Programa de Posgrado'); ?>


            </h1>

            <div class="hero-meta">
                <?php if(optional($oferta->modalidad)->nombre): ?>
                    <span class="hero-chip"><i
                            class="fa-solid fa-laptop-code"></i><?php echo e($oferta->modalidad->nombre); ?></span>
                <?php endif; ?>
                <?php if(optional($oferta->sucursal)->nombre): ?>
                    <span class="hero-chip"><i
                            class="fa-solid fa-location-dot"></i><?php echo e($oferta->sucursal->nombre); ?><?php echo e(optional(optional($oferta->sucursal)->sede)->nombre ? ' — ' . $oferta->sucursal->sede->nombre : ''); ?></span>
                <?php endif; ?>
                <?php if($oferta->n_modulos): ?>
                    <span class="hero-chip"><i class="fa-solid fa-layer-group"></i><?php echo e($oferta->n_modulos); ?>

                        módulos</span>
                <?php endif; ?>
                <?php if($oferta->gestion): ?>
                    <span class="hero-chip"><i class="fa-regular fa-calendar-check"></i>Gestión
                        <?php echo e($oferta->gestion); ?></span>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="main-grid">
            ...
            <div>
                    ...
                    <div class="asesor-card">
                        ...
                        <div class="asesor-header">
                            <div class="asesor-avatar">
                                <?php if($personaAsesor->fotografia): ?>
                                    <img src="<?php echo e(asset('images/personas/' . $personaAsesor->fotografia)); ?>"
                                        alt="<?php echo e($nombreAsesor); ?>"
                            ...
                            <div>
                                <div class="asesor-name"><?php echo e($nombreAsesor); ?></div>
                                <div class="asesor-cargo"><?php echo e(optional($asesor->cargo)->nombre ?? 'Asesor'); ?></div>
                                <?php if(optional($asesor->sucursale)->nombre): ?>
                                    <div class="asesor-suc"><i class="fa-solid fa-location-dot"
                                            style="color:var(--or1);font-size:.65rem;margin-right:.2rem;"></i><?php echo e($asesor->sucursale->nombre); ?>
                ...
                <?php if($enlace->planes_pago_id && $conceptosPlan->isNotEmpty()): ?>
                    <div class="plan-destacado">
                        <div class="plan-destacado-label">Plan de pago asignado</div>
                        <div class="plan-destacado-nombre"><?php echo e(optional($enlace->planesPago)->nombre ?? 'Plan'); ?></div>

                        <?php $totalBs = 0; ?>
                        <?php $__currentLoopData = $conceptosPlan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $totalBs += $pc->pago_bs; ?>
                            <div class="concepto-row">
                                <span
                                    class="concepto-nombre"><?php echo e(optional($pc->concepto)->nombre ?? 'Concepto'); ?></span>
                                <span>
                                    <span class="concepto-precio">Bs.
                                        <?php echo e(number_format($pc->pago_bs, 0, '.', ',')); ?></span>
                                    <?php if($pc->n_cuotas > 1): ?>
                                        <span class="concepto-cuotas">× <?php echo e($pc->n_cuotas); ?> cuotas</span>
                                    <?php endif; ?>
                                </span>
                            </div>
                        ...
                        <div class="concepto-total">
                            ...
                            <span class="amount">Bs. <?php echo e(number_format($totalBs, 0, '.', ',')); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($oferta->modulos && $oferta->modulos->count() > 0): ?>
                    <div class="info-card">
                        <h3><i class="fa-solid fa-list-check"></i> Módulos del Programa</h3>
                        <?php $__currentLoopData = $oferta->modulos->sortBy('orden'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="modulo-item">
                                <div class="mod-num"><?php echo e($i + 1); ?></div>
                                <div class="mod-info">
                                    <div class="mod-name"><?php echo e($modulo->nombre); ?></div>
                                    <?php if(optional(optional($modulo->docente)->persona)->nombres): ?>
            ...
            <div>
                <div class="form-card" id="formCard">
                    ...
                    <?php if($enlace->planes_pago_id && optional($enlace->planesPago)->nombre): ?>
                        <div class="form-plan-resumen">
                            <i class="fa-solid fa-circle-check"></i>
                            <div>
                                <strong>Plan asignado: <?php echo e($enlace->planesPago->nombre); ?></strong>
                    ...
                    <form id="preinscripcionForm" method="POST"
                        action="<?php echo e(route('preinscripcion.store', ['token' => $token])); ?>" novalidate>
                        <?php echo csrf_field(); ?>

                        <div class="form-group">
                            <label class="form-label">Nombres <span class="req">*</span></label>
                            <input type="text" name="nombres"
                                class="form-control <?php echo e($errors->has('nombres') ? 'is-invalid' : ''); ?>"
                                placeholder="Tus nombres" value="<?php echo e(old('nombres')); ?>" required>
                        </div>
                        ...
                        <div class="row-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido_paterno"
                                    class="form-control <?php echo e($errors->has('apellido_paterno') ? 'is-invalid' : ''); ?>"
                                    placeholder="Paterno" value="<?php echo e(old('apellido_paterno')); ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Apellido materno</label>
                                <input type="text" name="apellido_materno" class="form-control"
                                    placeholder="Materno" value="<?php echo e(old('apellido_materno')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="carnet" class="form-control" placeholder="Ej: 12345678"
                                    value="<?php echo e(old('carnet')); ?>">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Teléfono / WhatsApp</label>
                                <input type="text" name="telefono" class="form-control"
                                    placeholder="Ej: 70123456" value="<?php echo e(old('telefono')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control"
                                placeholder="tucorreo@ejemplo.com" value="<?php echo e(old('email')); ?>">
                        </div>

                        <div class="form-group">
                            <label class="form-label">Observaciones</label>
                            <textarea name="observacion" class="form-control" placeholder="¿Alguna pregunta o comentario?"><?php echo e(old('observacion')); ?></textarea>
                        </div>
    ...
    <footer>
        <div class="container">
            <p>© <?php echo e(date('Y')); ?> <span>Innova Ciencia Virtual</span> — Todos los derechos reservados</p>
        </div>
    </footer>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/preinscripcion/index.blade.php ENDPATH**/ ?>