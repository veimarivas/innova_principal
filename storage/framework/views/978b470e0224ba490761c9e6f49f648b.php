<?php $__env->startSection('title'); ?> Departamentos <?php $__env->stopSection(); ?>
...
(function () {
    ...
    function initDataTable() {
        tabla = $('#tabla-departamentos').DataTable({
            ajax: { url: '<?php echo e(route("admin.departamentos.listar")); ?>', dataSrc: 'data' },
            ordering: true,
            columns: [
                {
                    data: 'nombre',
    ...
    function guardar() {
        ...
        $.post('<?php echo e(route("admin.departamentos.guardar")); ?>', {
            _token: CSRF,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/departamentos/index.blade.php ENDPATH**/ ?>