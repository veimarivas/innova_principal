...
<div class="row g-4 align-items-start">
    ...
    <div class="col-md-4 text-center">
        <div style="background:#fff;border-radius:12px;padding:.9rem;display:inline-block;box-shadow:0 4px 20px rgba(0,0,0,.15);">
            <div id="qrContainer<?php echo e($prefix); ?>"></div>
        </div>
    ...
    <div class="col-md-8">
        ...
        <div style="display:flex;gap:.45rem;margin-bottom:.9rem;">
            <input type="text" id="urlInput<?php echo e($prefix); ?>" readonly
            ...
            <button type="button" onclick="copiarEnlace('<?php echo e($prefix); ?>')"
                id="btnCopiar<?php echo e($prefix); ?>"
                ...
                <i class="ri-file-copy-line"></i><span id="lblCopiar<?php echo e($prefix); ?>">Copiar</span>
            </button>
        </div>
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a id="btnAbrir<?php echo e($prefix); ?>" href="#" target="_blank"
            ...
            <button type="button" onclick="descargarQr('<?php echo e($prefix); ?>')"
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/profile/modals/partials/enlace-display.blade.php ENDPATH**/ ?>