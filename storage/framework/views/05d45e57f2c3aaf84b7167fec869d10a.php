                ...
                <div class="est-stat-body">
                    ...
                    <div>
                        <div class="est-stat-value" style="color: var(--est-success);">Bs.
                            <?php echo e(number_format($totalPagado, 2)); ?></div>
                ...
                <div class="est-stat-body">
                    ...
                    <div>
                        <div class="est-stat-value" style="color: var(--est-warning);">Bs.
                            <?php echo e(number_format($totalPendiente, 2)); ?></div>
                ...
                <div class="est-stat-body">
                    ...
                    <div>
                        <div class="est-stat-value" style="color: var(--est-danger);">Bs.
                            <?php echo e(number_format($totalVencido, 2)); ?></div>
    ...
    <?php if($inscripciones->count() > 0): ?>
        <div class="est-oferta-tabs-nav">
            <?php $__currentLoopData = $inscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button" class="est-oferta-tab-btn <?php echo e($key == 0 ? 'active' : ''); ?>"
                    data-target="contable-oferta-<?php echo e($key); ?>">
                    <i class="ri-money-dollar-circle-line"></i>
                    <?php echo e($ins->ofertaAcademica?->posgrado?->nombre ?? 'Oferta ' . ($key + 1)); ?>
                    ...
                    <div class="est-data-card-header">
                        ...
                        <div style="flex: 1;">
                            <h5 class="est-data-card-title">
                                <?php echo e($ins->ofertaAcademica?->posgrado?->nombre ?? 'Oferta #' . $ins->ofertas_academica_id); ?>

                            </h5>
                            <div style="font-size: 0.75rem; color: var(--est-text-muted);">Plan:
                                <?php echo e($ins->planesPago?->nombre ?? '—'); ?></div>
                        </div>
                    </div>
                    <?php
                        $insPagado = 0;
                            ...
                            <div class="est-stat-body" style="border-right: 1px solid var(--d-row-border);">
                                ...
                                <div>
                                    <div class="est-stat-value"
                                        ...
                                        <?php echo e(number_format($insPagado, 2)); ?></div>
                            ...
                            <div class="est-stat-body" style="border-right: 1px solid var(--d-row-border);">
                                ...
                                <div>
                                    <div class="est-stat-value"
                                        ...
                                        <?php echo e(number_format($insPendiente, 2)); ?></div>
                                    <div class="est-stat-label">Pendiente</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="est-stat-body">
                                ...
                                <div>
                                    <div class="est-stat-value"
                                        ...
                                        <?php echo e(number_format($insVencido, 2)); ?></div>
                                    <div class="est-stat-label">Vencido</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cuotas-card" style="border-top: 1px solid var(--d-row-border);">
                            <div
                                ...
                                <button type="button"
                                    ...
                                    data-inscripcion-id="<?php echo e($ins->id); ?>"
                                    data-oferta="<?php echo e($ins->ofertaAcademica?->posgrado?->nombre ?? 'Oferta #' . $ins->ofertas_academica_id); ?>"
                                    data-cuotas='<?php echo e(json_encode($cuotasData)); ?>'
                            ...
                            <table class="cuotas-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $ins->cuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="cuota-num"><?php echo e($cuota->n_cuota); ?></div>
                                            </td>
                                            <td class="fw-medium"><?php echo e($cuota->nombre); ?></td>
                                            <td class="cuota-monto">Bs. <?php echo e(number_format($cuota->monto_bs, 2)); ?></td>
                                            <td><?php echo e($cuota->descuento_bs > 0 ? 'Bs. ' . number_format($cuota->descuento_bs, 2) : '—'); ?>

                                            </td>
                                            <td class="cuota-pendiente">Bs.
                                                <?php echo e(number_format($cuota->pago_pendiente_bs ?? $cuota->monto_bs, 2)); ?>

                                            </td>
                                            <td>
                                                <div class="cuota-vencimiento <?php echo e($claseVenc); ?>" style="background: <?php echo e($claseVenc == 'vencido' ? 'rgba(220,38,38,0.1)' : ($claseVenc == 'ok' ? 'rgba(34,197,94,0.1)' : 'transparent')); ?>; padding: 4px 8px; border-radius: 6px;">
                                                    <span class="fecha" style="color: <?php echo e($colorFecha); ?>; font-weight: 600;"><?php echo e($vencDate ? $vencDate->format('d/m/Y') : '—'); ?></span>
                                                    <?php if($diasFaltantes !== null && $cuota->estado != 'Pagado'): ?>
                                                        <span class="dias-restantes" style="display: block; font-size: 0.65rem; color: <?php echo e($claseVenc == 'vencido' ? '#dc2626' : ($claseVenc == 'ok' ? '#22c55e' : '#64748b')); ?>;">
                                                            <?php if($diasFaltantes < 0): ?>
                                                                <?php echo e(abs($diasFaltantes)); ?> días vencido
                                                            <?php elseif($diasFaltantes == 0): ?>
                                                                Vence hoy
                                                            <?php else: ?>
                                                                <?php echo e($diasFaltantes); ?> días faltantes
                                                            <?php endif; ?>
                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <td class="cuota-pago-fecha">
                                                <?php if($cuota->estado != 'Pagado'): ?>
                                                    —
                                                <?php else: ?>
                                                    <?php echo e($cuota->fecha_pago ? \Carbon\Carbon::parse($cuota->fecha_pago)->format('d/m/Y') : '—'); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td class="cuota-total-pagado">Bs. <?php echo e(number_format($totalPagadoCuota, 2)); ?></td>
                                            <td>
                                                <span class="cuota-estado-pill <?php echo e($estadoClass); ?>"><?php echo e($cuota->estado); ?></span>
                                            </td>
                                            <td>
                                                <?php
                                                    $pagosData = [];
                                                ...
                                                <div class="cuota-actions">
                                                    <?php if($cuota->estado != 'Pagado'): ?>
                                                        <button type="button"
                                                            ...
                                                            data-id="<?php echo e($cuota->id); ?>"
                                                            data-nombre="<?php echo e($cuota->nombre); ?>"
                                                            data-monto="<?php echo e($cuota->pago_pendiente_bs ?? $cuota->monto_bs); ?>"
                                                            title="Pagar">
                                                            <i class="ri-money-dollar-circle-line"></i>
                                                        </button>
                                                    <?php endif; ?>
                                                    <?php if(count($pagosData) > 0): ?>
                                                        <button type="button"
                                                            ...
                                                            data-pagos='<?php echo e($pagosDataJson); ?>'
                                                            title="Ver Detalle">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        ...
                        <?php if($trabajadorActual): ?>
                            <small class="text-muted d-block">
                                <i class="ri-user-line"></i> Registrado por:
                                <strong><?php echo e($trabajadorActual['nombre']); ?></strong> -
                                <?php echo e($trabajadorActual['cargo']); ?>

                                <?php if($trabajadorActual['sucursal']): ?>
                                    (<?php echo e($trabajadorActual['sucursal']); ?>

                                    <?php if($trabajadorActual['sede']): ?>
                                        - <?php echo e($trabajadorActual['sede']); ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="pago-fecha" name="fecha_pago"
                                    value="<?php echo e(now('America/La_Paz')->format('Y-m-d')); ?>"
                                    required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <input type="hidden" id="pago-trabajador-cargo" name="trabajador_cargo_id"
                                value="<?php echo e($trabajadorActual['id'] ?? ''); ?>">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6" id="pago-cuenta-bancaria-container" style="display:none;">
                                ...
                                <select class="form-select" id="pago-cuenta-bancaria" name="cuenta_bancaria_id">
                                    ...
                                    <?php $__currentLoopData = $cuentasBancarias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuenta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cuenta->id); ?>"><?php echo e($cuenta->banco->nombre); ?> - <?php echo e($cuenta->numero_cuenta); ?> (<?php echo e($cuenta->tipo_cuenta); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
</div><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/estudiantes/partials/tab-contable.blade.php ENDPATH**/ ?>