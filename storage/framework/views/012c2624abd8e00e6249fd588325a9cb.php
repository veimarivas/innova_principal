...
<?php $__env->startSection('content'); ?>
    ...
    <div class="cont-page" style="padding: 24px;">
        <div class="cont-header">
            <div>
                ...
                <p>Período: <?php echo e($nombreMes); ?> <?php echo e($gestion); ?> | Resumen financiero de todas las ofertas académicas</p>
            </div>
            <div class="header-stats">
                <div class="cont-header-stat">
                    <div class="cont-header-stat-value"><?php echo e(number_format($totalesGlobales['total_inscritos'])); ?></div>
                    <div class="cont-header-stat-label">Inscritos</div>
                </div>
                <div class="cont-header-stat">
                    <div class="cont-header-stat-value">Bs.
                        <?php echo e(number_format($totalesGlobales['total_programado'], 0, ',', '.')); ?></div>
                    <div class="cont-header-stat-label">Programado</div>
                </div>
                <div class="cont-header-stat">
                    <div class="cont-header-stat-value" style="color: #34d399;">Bs.
                        <?php echo e(number_format($totalesGlobales['total_pagado'], 0, ',', '.')); ?></div>
        ...
        <div class="cont-kpi-grid">
                ...
                <div class="cont-kpi-body">
                    <div class="cont-kpi-header">
                        ...
                        <span class="cont-kpi-trend up">
                            <i class="ri-arrow-up-line"></i> <?php echo e(number_format($porcentajeGlobal, 1)); ?>%
                        </span>
                    </div>
                    <div class="cont-kpi-value"><?php echo e(number_format($totalesGlobales['total_inscritos'])); ?></div>
                    <div class="cont-kpi-label">Total Inscritos</div>
                </div>
                <div class="cont-kpi-bar">
                    <div class="cont-kpi-bar-fill"
                        style="width: <?php echo e(min($porcentajeGlobal, 100)); ?>%; background: linear-gradient(90deg, #6366f1, #8b5cf6);">
                    </div>
                </div>
            </div>
            ...
            <div class="cont-kpi-card kpi-programado">
                <div class="cont-kpi-body">
                    ...
                    <div class="cont-kpi-value">Bs. <?php echo e(number_format($totalesGlobales['total_programado'], 0, ',', '.')); ?>
            ...
            <div class="cont-kpi-card kpi-pagado">
                <div class="cont-kpi-body">
                    <div class="cont-kpi-header">
                        ...
                        <span class="cont-kpi-trend up">
                            ...
                            <?php echo e(number_format(($totalPagado / max($totalesGlobales['total_programado'], 1)) * 100, 1)); ?>%
                        </span>
                    </div>
                    <div class="cont-kpi-value">Bs. <?php echo e(number_format($totalesGlobales['total_pagado'], 0, ',', '.')); ?>
                ...
                <div class="cont-kpi-bar">
                    <div class="cont-kpi-bar-fill"
                        style="width: <?php echo e(($totalPagado / max($totalesGlobales['total_programado'], 1)) * 100); ?>%; background: linear-gradient(90deg, #059669, #10b981);">
                    </div>
                </div>
            </div>
            ...
            <div class="cont-kpi-card kpi-pendiente">
                <div class="cont-kpi-body">
                    <div class="cont-kpi-header">
                        ...
                        <span class="cont-kpi-trend <?php echo e($trendClass); ?>">
                            <i class="ri-<?php echo e($trendClass === 'up' ? 'arrow-up' : 'arrow-down'); ?>-line"></i>
                            <?php echo e(number_format(($totalPendiente / max($totalesGlobales['total_programado'], 1)) * 100, 1)); ?>%
                        </span>
                    </div>
                    <div class="cont-kpi-value">Bs. <?php echo e(number_format($totalesGlobales['total_pendiente'], 0, ',', '.')); ?>
                ...
                <div class="cont-kpi-bar">
                    <div class="cont-kpi-bar-fill"
                        style="width: <?php echo e(($totalPendiente / max($totalesGlobales['total_programado'], 1)) * 100); ?>%; background: linear-gradient(90deg, #dc2626, #f87171);">
                    </div>
                </div>
            </div>
        </div>
        <form method="GET" action="<?php echo e(route('admin.contabilidad.dashboard')); ?>" class="cont-filters"
            ...
            <select name="gestion" class="form-select"
                ...
                <?php $__currentLoopData = $gestiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($g); ?>" <?php echo e($gestion == $g ? 'selected' : ''); ?>><?php echo e($g); ?>
            ...
            <select name="mes" class="form-select"
                ...
                <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($num); ?>" <?php echo e($mes == $num ? 'selected' : ''); ?>><?php echo e($nombre); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        ...
        <div class="cont-chart-card" style="margin-bottom: 24px;">
            <div class="cont-chart-header">
                <div class="cont-chart-title">
                    ...
                    Ingresos Diarios por Concepto - <?php echo e($nombreMes); ?> <?php echo e($gestion); ?>
        ...
        <div class="cont-charts-row">
            ...
            <div class="cont-chart-card" style="border-top: 3px solid #6366f1;">
                <div class="cont-chart-header">
                    ...
                    <span class="cont-chart-badge"><?php echo e($nombreMes); ?> <?php echo e($gestion); ?></span>
                </div>
                <div class="chart-doughnut-wrap">
                    <canvas id="chartConceptos"></canvas>
                    <div class="chart-center-label">
                        <div class="chart-center-value">Bs.&nbsp;<?php echo e(number_format($totalesGlobales['total_programado'], 0, ',', '.')); ?></div>
            ...
            <div class="cont-chart-card" style="border-top: 3px solid #0d9488;">
                ...
                <div class="chart-hbars">
                    <?php $__currentLoopData = $conceptosGlobales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concepto => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="chart-hbar-item">
                            <div class="chart-hbar-meta">
                                <div class="chart-hbar-concept">
                                    <span class="chart-hbar-concept-dot" style="background:<?php echo e($dotColor); ?>;"></span>
                                    <?php echo e($concepto); ?>

                                </div>
                                <div class="chart-hbar-right">
                                    <span class="chart-hbar-pct" style="color:<?php echo e($pctClr); ?>;"><?php echo e(number_format($pctBar, 1)); ?>%</span>
                                    <span class="chart-hbar-of">cobrado</span>
                                </div>
                            </div>
                            <div class="chart-hbar-track">
                                <div class="chart-hbar-fill" style="--tw:<?php echo e($twVal); ?>%; background:<?php echo e($barGrad); ?>;"></div>
                            </div>
                            <div class="chart-hbar-amounts">
                                <span class="chart-hbar-cobrado" style="color:<?php echo e($pctClr); ?>;">Bs.&nbsp;<?php echo e(number_format($datos['pagado'], 0, ',', '.')); ?></span>
                                <span class="chart-hbar-total">de Bs.&nbsp;<?php echo e(number_format($datos['total'], 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="cont-chart-card" style="border-top: 3px solid #059669;">
                ...
                <div class="chart-doughnut-wrap">
                    ...
                    <div class="chart-center-label">
                        <div class="chart-estado-pct-big" style="color:<?php echo e($colorPorcentaje); ?>;"><?php echo e(number_format($porcentajeGlobal, 1)); ?>%</div>
                ...
                <div class="chart-estado-cards">
                    <div class="chart-estado-mini" style="border-left-color:#059669;">
                        <div class="chart-estado-mini-value" style="color:#059669;">Bs.&nbsp;<?php echo e(number_format($totalPagado, 0, ',', '.')); ?></div>
                    ...
                    <div class="chart-estado-mini" style="border-left-color:#dc2626;">
                        <div class="chart-estado-mini-value" style="color:#dc2626;">Bs.&nbsp;<?php echo e(number_format($totalPendiente, 0, ',', '.')); ?></div>
        ...
        <div class="rc-grid">
            <?php $__currentLoopData = $conceptosGlobales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concepto => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="rc-card">
                    <div class="rc-card-accent" style="background: <?php echo e($rcColor); ?>;"></div>
                    <div class="rc-card-body">
                        <div class="rc-top">
                            <div class="rc-icon-wrap">
                                <div class="rc-icon" style="background:<?php echo e($rcColor); ?>18; color:<?php echo e($rcColor); ?>;">
                                    <i class="ri-<?php echo e($rcIcon); ?>"></i>
                                </div>
                                <div>
                                    <div class="rc-name"><?php echo e($concepto); ?></div>
                                    <div class="rc-cuotas">
                                        <i class="ri-coins-line"></i>
                                        <?php echo e($datos['cantidad_cuotas']); ?> cuota(s)
                                    </div>
                                </div>
                            </div>
                            <div style="text-align: right; flex-shrink: 0;">
                                <div class="rc-pct-badge" style="color:<?php echo e($rcPctClr); ?>;"><?php echo e(number_format($rcPct, 1)); ?>%</div>
                                <div class="rc-pct-label">cobrado</div>
                            </div>
                        </div>
                        <div class="rc-track">
                            <div class="rc-fill" style="--tw:<?php echo e($rcTw); ?>%; background:<?php echo e($rcGrad); ?>;"></div>
                        </div>
                        <div class="rc-stats">
                            <div class="rc-stat">
                                <div class="rc-stat-value">Bs.&nbsp;<?php echo e(number_format($datos['total'], 0, ',', '.')); ?></div>
                                <div class="rc-stat-label">Programado</div>
                            </div>
                            <div class="rc-stat">
                                <div class="rc-stat-value" style="color:#059669;">Bs.&nbsp;<?php echo e(number_format($datos['pagado'], 0, ',', '.')); ?></div>
                                <div class="rc-stat-label">Cobrado</div>
                            </div>
                            <div class="rc-stat">
                                <div class="rc-stat-value" style="color:#dc2626;">Bs.&nbsp;<?php echo e(number_format($datos['pendiente'], 0, ',', '.')); ?></div>
        ...
        <?php $__currentLoopData = $ofertasData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oferta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <div class="oferta-card" id="card-<?php echo e($oferta['id']); ?>">

                
                <div class="oferta-head" onclick="toggleOferta('<?php echo e($oferta['id']); ?>')">
                    <div>
                        <div class="oferta-head-title">
                            <span class="oferta-codigo-chip"><?php echo e($oferta['codigo']); ?></span>
                            <?php echo e($oferta['programa'] ?? 'Programa'); ?>
                        ...
                        <div class="oferta-meta-row">
                            ...
                            <span class="cont-fase-badge <?php echo e($ofFaseClass); ?>" style="padding:3px 9px; font-size:0.68rem; margin-left:4px;">
                                <i class="ri-<?php echo e($ofFaseIcon); ?>"></i> <?php echo e($oferta['fase'] ?? '—'); ?>

                            </span>
                        </div>
                        <div class="oferta-progress-mini">
                            <div class="oferta-progress-mini-fill" style="width:<?php echo e($ofPctFmt); ?>%; background:<?php echo e($ofGrad); ?>;"></div>
                        </div>
                    </div>
                    ...
                    <div class="oferta-head-right">
                        <div class="oferta-kpi-strip">
                            <div class="oferta-kpi">
                                <div class="oferta-kpi-value"><?php echo e($oferta['inscritos']); ?></div>
                                <div class="oferta-kpi-label">Inscritos</div>
                            </div>
                            <div class="oferta-kpi">
                                <div class="oferta-kpi-value"><?php echo e(number_format($oferta['total_programado'], 0, ',', '.')); ?></div>
                                <div class="oferta-kpi-label">Prog. Bs.</div>
                            </div>
                            <div class="oferta-kpi">
                                <div class="oferta-kpi-value" style="color:#059669;"><?php echo e(number_format($oferta['total_pagado'], 0, ',', '.')); ?></div>
                                <div class="oferta-kpi-label">Cobrado Bs.</div>
                            </div>
                            <div class="oferta-kpi">
                                <div class="oferta-kpi-value" style="color:#dc2626;"><?php echo e(number_format($oferta['total_pendiente'], 0, ',', '.')); ?></div>
                                <div class="oferta-kpi-label">Pendiente Bs.</div>
                            </div>
                            <div class="oferta-kpi">
                                <div class="oferta-kpi-value" style="color:<?php echo e($ofPctClr); ?>;"><?php echo e(number_format($oferta['porcentaje_pagado'], 1)); ?>%</div>
                                <div class="oferta-kpi-label">% Cobrado</div>
                            </div>
                        </div>
                        <div class="oferta-actions">
                            <a href="<?php echo e(url('/admin/posgrads/ofertas/' . $oferta['id'] . '/detalle')); ?>"
                               class="oferta-link-btn"
                               onclick="event.stopPropagation();"
                               title="Ver detalle completo de la oferta">
                                <i class="ri-external-link-line"></i> Ver oferta
                            </a>
                            <button class="oferta-toggle-btn" id="btn-<?php echo e($oferta['id']); ?>" type="button"
                                    onclick="event.stopPropagation(); toggleOferta('<?php echo e($oferta['id']); ?>');">
                ...
                <div id="oferta-<?php echo e($oferta['id']); ?>" class="oferta-body">
                    <div class="oferta-conceptos-grid">
                        <?php $__currentLoopData = ['Matrícula', 'Colegiatura', 'Certificación']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concepto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <div class="oferta-concepto-block <?php echo e($cbEmpty ? 'oferta-empty-concepto' : ''); ?>">
                                <div style="position:absolute;top:0;left:0;right:0;height:3px;background:<?php echo e($cbColor); ?>;border-radius:0;"></div>
                                <div class="oferta-cb-header">
                                    <div class="oferta-cb-icon" style="background:<?php echo e($cbColor); ?>18; color:<?php echo e($cbColor); ?>;">
                                        <i class="ri-<?php echo e($cbIcon); ?>"></i>
                                    </div>
                                    <div>
                                        <div class="oferta-cb-name"><?php echo e($concepto); ?></div>
                                        <div class="oferta-cb-cuotas">
                                            <i class="ri-coins-line"></i>
                                            <?php echo e($cbDatos['cantidad_cuotas'] ?? count($cbDatos['cuotas'] ?? [])); ?> cuota(s)
                                        </div>
                                    </div>
                                </div>
                                <?php if(!$cbEmpty): ?>
                                    <div class="oferta-cb-pct-row">
                                        <div class="oferta-cb-pct" style="color:<?php echo e($cbPctClr); ?>;"><?php echo e(number_format($cbPct, 1)); ?>%</div>
                                        <div class="oferta-cb-pct-label">cobrado</div>
                                    </div>
                                    <div class="oferta-cb-track">
                                        <div class="oferta-cb-fill" style="--tw:<?php echo e($cbTw); ?>%; background:<?php echo e($cbGrad); ?>;"></div>
                                    </div>
                                    <div class="oferta-cb-stats">
                                        <div class="oferta-cb-stat">
                                            <div class="oferta-cb-stat-value" style="color:#059669;">Bs.&nbsp;<?php echo e(number_format($cbDatos['pagado'], 0, ',', '.')); ?></div>
                                            <div class="oferta-cb-stat-label">Cobrado</div>
                                        </div>
                                        <div class="oferta-cb-stat">
                                            <div class="oferta-cb-stat-value" style="color:#dc2626;">Bs.&nbsp;<?php echo e(number_format($cbDatos['pendiente'], 0, ',', '.')); ?></div>
                                            <div class="oferta-cb-stat-label">Pendiente</div>
                                        </div>
                                        <div class="oferta-cb-stat full">
                                            <div class="oferta-cb-stat-value">Bs.&nbsp;<?php echo e(number_format($cbDatos['total'], 0, ',', '.')); ?></div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const totales = [<?php echo e($conceptosGlobales['Matrícula']['total'] ?? 0); ?>,
                <?php echo e($conceptosGlobales['Colegiatura']['total'] ?? 0); ?>,
                <?php echo e($conceptosGlobales['Certificación']['total'] ?? 0); ?>

            ];
            const pagados = [<?php echo e($conceptosGlobales['Matrícula']['pagado'] ?? 0); ?>,
                <?php echo e($conceptosGlobales['Colegiatura']['pagado'] ?? 0); ?>,
                <?php echo e($conceptosGlobales['Certificación']['pagado'] ?? 0); ?>

            ];
            const porcentajes = [
                <?php echo e($conceptosGlobales['Matrícula']['total'] > 0 ? ($conceptosGlobales['Matrícula']['pagado'] / $conceptosGlobales['Matrícula']['total']) * 100 : 0); ?>,
                <?php echo e($conceptosGlobales['Colegiatura']['total'] > 0 ? ($conceptosGlobales['Colegiatura']['pagado'] / $conceptosGlobales['Colegiatura']['total']) * 100 : 0); ?>,
                <?php echo e($conceptosGlobales['Certificación']['total'] > 0 ? ($conceptosGlobales['Certificación']['pagado'] / $conceptosGlobales['Certificación']['total']) * 100 : 0); ?>
            ...
            new Chart(document.getElementById('chartEstado'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($totalPagado); ?>, <?php echo e($totalPendiente); ?>],
            ...
            new Chart(document.getElementById('chartIngresosDiarios'), {
                type: 'line',
                data: {
                    labels: <?php echo e(json_encode($labelsDias)); ?>,
                    datasets: [{
                            label: 'Matrícula',
                            data: <?php echo e(json_encode($datosMatricula)); ?>,
                            borderColor: '#6366f1',
                        ...
                        {
                            label: 'Colegiatura',
                            data: <?php echo e(json_encode($datosColegiatura)); ?>,
                            borderColor: '#0891b2',
                        ...
                        {
                            label: 'Certificación',
                            data: <?php echo e(json_encode($datosCertificacion)); ?>,
                            borderColor: '#d97706',
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/contabilidad/index.blade.php ENDPATH**/ ?>