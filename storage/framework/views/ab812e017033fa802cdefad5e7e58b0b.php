            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="index" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('build/images/logo_chico.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e(URL::asset('build/images/logo_grande.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button"
                            ...
                            <?php if($comprobantesPendientes > 0): ?>
                                <span
                                    class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><?php echo e($comprobantesPendientes); ?><span
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <a href="<?php echo e(route('admin.comprobantes.index', ['tab' => 'nuevos'])); ?>"
                                                            class="stretched-link">
                                                            <h6 class="mt-0 mb-2 lh-base">Tienes <b
                                                                    class="text-danger"><?php echo e($comprobantesPendientes); ?></b>
                    ...
                    <?php if($moodleConectado !== null): ?>
                        <div class="ms-2 header-item d-none d-sm-flex align-items-center">
                            <span class="moodle-status-badge <?php echo e($moodleConectado ? 'moodle-online' : 'moodle-offline'); ?>"
                                title="<?php echo e($moodleConectado ? 'Moodle conectado' : 'Moodle desconectado'); ?>">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user topbar-user-dropdown">
                        <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                <img class="rounded-circle header-profile-user" src="<?php echo e($topbarAvatar); ?>" alt="Avatar">
                                <span class="text-start ms-xl-2">
                                    <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e($topbarNombre); ?></span>
                                    <span
                                        class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e($topbarRol); ?></span>
                                </span>
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end tud-menu">
                            <div class="tud-header">
                                <div class="tud-avatar-wrap">
                                    <img src="<?php echo e($topbarAvatar); ?>" alt="Avatar" class="tud-avatar">
                                </div>
                                <div class="tud-info">
                                    <div class="tud-name"><?php echo e($topbarNombre); ?></div>
                                    <span class="tud-role"><?php echo e($topbarRol); ?></span>
                                </div>
                            </div>
                            <div class="tud-body">
                                <a class="tud-item" href="<?php echo e(route('admin.profile.index')); ?>">
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>