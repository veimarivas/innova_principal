<?php $__env->startSection('title', 'Todas las Ofertas Académicas'); ?>
    ...
    <script>
        ...
        $(function() {
            var table = $('#tabla-ofertas-global').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.ofertas.listarGlobal')); ?>',
            ...
            function cargarCatalogos(callback) {
                ...
                Promise.all([
                    $.ajax({
                        url: '<?php echo e(route('admin.grados-academicos.listar')); ?>',
                        type: 'GET'
                    }),
                    $.ajax({
                        url: '<?php echo e(route('admin.universidades.listar')); ?>',
                        type: 'GET'
                    }),
                    $.ajax({
                        url: '<?php echo e(route('admin.profesiones.listar')); ?>',
                        type: 'GET'
                    }),
            ...
            $('#btnBuscarEstudiante').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.estudiantes.buscarCarnet')); ?>',
                    type: 'POST',
                    data: {
                        carnet: carnet,
                        _token: '<?php echo e(csrf_token()); ?>'
            ...
            $(document).on('click', '#btnRegistrarNuevaPersona', function() {
                ...
                if ($('#inputDepartamento option').length <= 1) {
                    $.ajax({
                        url: '<?php echo e(route('admin.departamentos.listar')); ?>',
                        type: 'GET',
                        success: function(response) {
            ...
            function validarCampo(carnet, correo) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.estudiantes.validarCampos')); ?>',
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        carnet: carnet,
            ...
            $('#btnConfirmarRegistrarPersona').on('click', function() {
                ...
                $.ajax({
                    ...
                    data: $('#formRegistrarPersona').serialize() +
                        '&_token=<?php echo e(csrf_token()); ?>&estudios_json=' + encodeURIComponent(JSON
            ...
            $(document).on('click', '#btnRegistrarComoEstudiante, #btnConfirmarRegistrarEstudiante', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.estudiantes.registrar')); ?>',
                    type: 'POST',
                    data: {
            ...
            function abrirModalComprobanteInscripcion(inscripcionId, nombreEstudiante) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.ofertas.inscripcion.cuotas', ':id')); ?>'.replace(':id',
                        inscripcionId),
                    type: 'GET',
                    success: function(data) {
            ...
            $('#btnEnviarComprobanteInscripcion').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.ofertas.inscripcion.comprobante')); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/ofertas-academicas/listar.blade.php ENDPATH**/ ?>