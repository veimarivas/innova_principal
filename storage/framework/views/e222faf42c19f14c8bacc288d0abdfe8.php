            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    ...
                    <select name="sucursal_id" id="ofertasSucursal" class="mkt-select">
                        ...
                        <?php $__currentLoopData = \App\Models\Sucursale::orderBy('nombre')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($suc->id); ?>"><?php echo e($suc->nombre); ?></option>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/profile/tabs/ofertas-activas.blade.php ENDPATH**/ ?>