...
<header class="hdr" id="hdr">
    <div class="hdr-inner">
        <a href="<?php echo e(route('welcome')); ?>" class="hdr-logo">
        ...
        <ul class="nav-links">
            <li><a href="<?php echo e(route('welcome')); ?>#inicio">Inicio</a></li>
            <li><a href="<?php echo e(route('welcome')); ?>#nosotros">Nosotros</a></li>
            <li><a href="<?php echo e(route('catalogo')); ?>" class="active">Catálogo</a></li>
            <li><a href="<?php echo e(route('welcome')); ?>#equipo">Equipo</a></li>
            <li><a href="<?php echo e(route('welcome')); ?>#sedes">Sedes</a></li>
            <li><a href="<?php echo e(route('welcome')); ?>#contacto">Contacto</a></li>
        </ul>
        <div class="hdr-cta">
            <?php if(auth()->check()): ?>
                <?php
                ...
                ?>
                <a href="<?php echo e($dashboardUrl); ?>" style="font-size:.78rem;font-weight:600;color:var(--orange);padding:.4rem .85rem;border:1px solid rgba(252,123,4,.4);border-radius:var(--radius-sm);transition:background .2s" onmouseover="this.style.background='rgba(252,123,4,.08)'" onmouseout="this.style.background=''"  >
                    Panel Admin
                </a>
            <?php endif; ?>
        </div>
...
<section class="cat-hero">
    <div class="cat-hero-inner">
        ...
        <div class="cat-hero-stats">
            <div class="hero-stat">
                <strong><?php echo e($ofertas->count()); ?></strong>
                <span>Programas</span>
            </div>
            <div class="hero-stat">
                <strong><?php echo e($tipos->count()); ?></strong>
                <span>Tipos</span>
            </div>
            <div class="hero-stat">
                <strong><?php echo e($convenios->count()); ?></strong>
                <span>Convenios</span>
            </div>
            <div class="hero-stat">
                <strong><?php echo e($sucursalesDisponibles->count()); ?></strong>
                <span>Sedes</span>
            </div>
        </div>
    </div>
        ...
        <div class="sidebar-inner">
            ...
            <div class="filter-group">
                ...
                <div class="filter-pills">
                    ...
                    <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="filter-pill" data-group="tipo" data-value="<?php echo e($tipo->id); ?>"><?php echo e($tipo->nombre); ?></button>
            ...
            <div class="filter-group">
                ...
                <div class="filter-pills">
                    ...
                    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="filter-pill" data-group="area" data-value="<?php echo e($area->id); ?>"><?php echo e($area->nombre); ?></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="filter-group">
                ...
                <div class="filter-pills">
                    ...
                    <?php $__currentLoopData = $convenios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="filter-pill" data-group="convenio" data-value="<?php echo e($conv->id); ?>"><?php echo e($conv->sigla ?? $conv->nombre); ?></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <?php if($sucursalesDisponibles->count()): ?>
            <div class="filter-group">
                ...
                <div class="filter-pills">
                    ...
                    <?php $__currentLoopData = $sucursalesDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="filter-pill" data-group="sucursal" data-value="<?php echo e($suc->id); ?>">
                            <?php echo e(optional($suc->sede)->nombre ? optional($suc->sede)->nombre.' – ' : ''); ?><?php echo e($suc->nombre); ?>
    ...
    <main class="cat-content">
        ...
        <div class="cat-topbar">
            <div style="display:flex;align-items:center;gap:1rem;flex-wrap:wrap">
                <p class="results-info">Mostrando <strong id="resultsCount"><?php echo e($ofertas->count()); ?></strong> de <?php echo e($ofertas->count()); ?> programas</p>
...
<?php $__empty_1 = true; $__currentLoopData = $ofertas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oferta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="oferta-card"
                     ...
                     data-area-id="<?php echo e($areaId); ?>"
                     data-convenio-id="<?php echo e($convenioId); ?>"
                     data-sucursal-id="<?php echo e($sucursalId); ?>"
                     data-search="<?php echo e($searchStr); ?>">
                    <div class="card-img">
                        <?php if($oferta->portada): ?>
                            <img src="<?php echo e(asset('storage/' . $oferta->portada)); ?>"
                                 ...
                                 onerror="this.src='https://placehold.co/600x340/1a1a1a/fc7b04?text=<?php echo e(urlencode($tipoNombre)); ?>'">
                        <?php else: ?>
                            <img src="https://placehold.co/600x340/1a1a1a/fc7b04?text=<?php echo e(urlencode($tipoNombre)); ?>"
                                 alt="<?php echo e(optional($oferta->programa)->nombre ?? optional($oferta->posgrado)->nombre); ?>">
                        <?php endif; ?>
                        <span class="badge-tipo"><?php echo e($tipoNombre); ?></span>
                        <?php if($oferta->fase): ?>
                            <span class="badge-fase"><?php echo e($oferta->fase->nombre); ?></span>
                        <?php endif; ?>
                    ...
                    <div class="card-body">
                        <div class="card-meta-top">
                            <?php if($areaNombre): ?>
                                <span class="tag-area"><i class="fas fa-layer-group"></i> <?php echo e($areaNombre); ?></span>
                            <?php endif; ?>
                            <?php if($convenioSigla): ?>
                                <span class="tag-convenio"><i class="fas fa-handshake"></i> <?php echo e($convenioSigla); ?></span>
                            <?php endif; ?>
                        </div>
                        <h3 class="card-title"><?php echo e(optional($oferta->posgrado)->nombre ?? 'Programa sin nombre'); ?></h3>
                        <div class="card-info">
                            <span class="info-item">
                                <i class="fas fa-map-marker-alt"></i> <?php echo e($sucursalNombre); ?>

                            </span>
                            <?php if($oferta->modalidad): ?>
                                <span class="info-item">
                                    <i class="fas fa-laptop"></i> <?php echo e($oferta->modalidad->nombre); ?>

                                </span>
                            <?php endif; ?>
                            <?php if($duracion): ?>
                                <span class="info-item">
                                    <i class="far fa-clock"></i> <?php echo e($duracion); ?>

                                </span>
                            <?php endif; ?>
                            <?php if($oferta->fecha_inicio_programa): ?>
                                <span class="info-item">
                                    <i class="far fa-calendar-alt"></i> Inicio: <?php echo e($oferta->fecha_inicio_programa->format('d/m/Y')); ?>
                        ...
                        <div class="card-footer">
                            <div class="card-price">
                                <?php if($precio > 0): ?>
                                    <span class="price-amount">Bs. <?php echo e(number_format($precio, 0, ',', '.')); ?></span>
                                    <span class="price-label"><?php echo e($primerPlanNombre ?: 'Precio total'); ?></span>
                                <?php else: ?>
                                    <span class="price-consult">Consultar precio</span>
                                <?php endif; ?>
                            </div>
                            <a href="<?php echo e(route('oferta.detalle', $oferta->id)); ?>" class="btn-detail">
...
<footer class="cat-footer">
    <div class="cat-footer-inner">
        ...
        <nav>
            ...
            <a href="<?php echo e(route('welcome')); ?>#equipo">Equipo</a>
            <a href="<?php echo e(route('welcome')); ?>#sedes">Sedes</a>
            <a href="<?php echo e(route('welcome')); ?>#contacto">Contacto</a>
        </nav>
    </div>
    <p class="copy">&copy; <?php echo e(date('Y')); ?> Innova Ciencia Virtual. Todos los derechos reservados.</p>
</footer>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/catalogo.blade.php ENDPATH**/ ?>