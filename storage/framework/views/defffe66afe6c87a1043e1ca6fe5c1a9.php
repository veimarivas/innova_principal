            ...
            <div class="modal-body" style="padding:1.5rem;">
                ...
                <div id="panelSinPlan">
                    ...
                    <div id="contentSinPlan" style="display:none;">
                        <?php echo $__env->make('admin.profile.modals.partials.enlace-display', ['prefix' => 'SinPlan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                ...
                <div id="panelConPlan" style="display:none;">
                    ...
                    <div id="contentConPlan" style="display:none;">
                        <?php echo $__env->make('admin.profile.modals.partials.enlace-display', ['prefix' => 'ConPlan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/profile/modals/enlace-preinscripcion.blade.php ENDPATH**/ ?>