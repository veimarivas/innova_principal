<?php $__env->startSection('title'); ?> Sedes <?php $__env->stopSection(); ?>
...
(function () {
    ...
    function initDataTable() {
        tabla = $('#tabla-sedes').DataTable({
            ajax: { url: '<?php echo e(route("admin.sedes.listar")); ?>', dataSrc: 'data' },
            ordering: true,
            columns: [
                {
                    data: 'nombre',
    ...
    function guardar() {
        ...
        $.post('<?php echo e(route("admin.sedes.guardar")); ?>', {
            _token: CSRF,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/sedes/index.blade.php ENDPATH**/ ?>