...
<head>
    ...
    <title><?php echo e(optional($oferta->posgrado)->nombre ?? 'Detalle del Programa'); ?> — Innova Ciencia Virtual</title>
...
<body>
    ...
    <header id="hdr">
        <div class="container">
            <nav class="nav">
                <a href="<?php echo e(route('welcome')); ?>" class="brand">
                ...
                <div style="display:flex;align-items:center;gap:1rem">
                    <a href="<?php echo e(route('catalogo')); ?>" class="back-link">
                    ...
                    <?php if(Route::has('login')): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn-primary" style="font-size:.8rem;padding:.5rem 1.1rem">
    ...
    <section class="hero" id="inicio">
        <div class="container">
            <div class="<?php if($oferta->portada): ?> hero-with-image <?php else: ?> hero-simple <?php endif; ?>">

                <?php if($oferta->portada): ?>
                    <div class="hero-image-showcase">
                        <img src="<?php echo e(asset('storage/' . $oferta->portada)); ?>"
                            alt="<?php echo e(optional($oferta->posgrado)->nombre); ?>">
                        <div class="hero-image-overlay"></div>
                        <?php if(optional($oferta->posgrado)->tipo): ?>
                            <div class="hero-image-badge">
                                <i class="fas fa-graduation-cap"></i>
                                <span><?php echo e($oferta->posgrado->tipo->nombre); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if(optional(optional($oferta->posgrado)->convenio)->imagen): ?>
                            <div class="hero-convenio-badge">
                                ...
                                <?php if(optional($oferta->posgrado)->convenio->nombre): ?>
                                    <span><?php echo e($oferta->posgrado->convenio->nombre); ?></span>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="hero-text-content">
                    ...
                    <div class="breadcrumb">
                        <a href="<?php echo e(route('welcome')); ?>"><i class="fas fa-home" style="font-size:.7rem"></i> Inicio</a>
                        <span>/</span>
                        <a href="<?php echo e(route('catalogo')); ?>">Catálogo</a>
                        <span>/</span>
                        <span
                            style="color:rgba(255,255,255,.6)"><?php echo e(optional($oferta->posgrado)->nombre ?? 'Programa'); ?></span>
                    </div>

                    <!-- Badges -->
                    <div class="hero-badges">
                        <?php if(optional(optional($oferta->posgrado)->tipo)->nombre && !$oferta->portada): ?>
                            <span class="badge-pill badge-type">
                                <i class="fas fa-graduation-cap"></i>
                                <?php echo e($oferta->posgrado->tipo->nombre); ?>

                            </span>
                        <?php endif; ?>
                        <?php if(optional($oferta->sucursal)->nombre): ?>
                            <span class="badge-pill badge-sede">
                                <i class="fas fa-map-marker-alt"></i>
                                <?php echo e(optional($oferta->sucursal->sede)->nombre); ?> — <?php echo e($oferta->sucursal->nombre); ?>
                        ...
                        <?php if($oferta->modalidad): ?>
                            <span class="badge-pill badge-sede">
                                ...
                                <?php echo e($oferta->modalidad->nombre); ?>
                    ...
                    <!-- Title -->
                    <h1 class="hero-title"><?php echo e(optional($oferta->posgrado)->nombre ?? 'Programa sin nombre'); ?></h1>
                    ...
                    <div class="hero-meta">
                        ...
                        <?php if($fechaFin): ?>
                            <div class="hero-meta-item">
                                ...
                                Fin: <?php echo e($fechaFin); ?>

                            </div>
                        <?php endif; ?>
                        <?php if(isset($oferta->posgrado->duracion_numero) && isset($oferta->posgrado->duracion_unidad)): ?>
                            <div class="hero-meta-item">
                                <i class="far fa-clock"></i>
                                <?php echo e($oferta->posgrado->duracion_numero); ?> <?php echo e($oferta->posgrado->duracion_unidad); ?>

                            </div>
                        <?php endif; ?>
                        <?php if($oferta->n_modulos): ?>
                            <div class="hero-meta-item">
                                <i class="fas fa-book"></i>
                                <?php echo e($oferta->n_modulos); ?> módulos
                            </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="container">
            <div class="layout-grid">
                ...
                <div class="left-col">
                    ...
                    <?php if(optional($oferta->posgrado)->objetivo): ?>
                        <div class="section-block" id="objetivo">
                            <h2 class="block-title"><i class="fas fa-bullseye"></i> Objetivo del Programa</h2>
                            <div class="prose">
                                <p><?php echo e($oferta->posgrado->objetivo); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>

                    
                    <?php if(optional($oferta->posgrado)->dirigido): ?>
                        <div class="section-block">
                            <h2 class="block-title"><i class="fas fa-users"></i> Dirigido a</h2>
                            <div class="directed-text"><?php echo e($oferta->posgrado->dirigido); ?></div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="section-block" id="modulos">
                        ...
                        <?php else: ?>
                            <div class="modules-list">
                                <?php $__currentLoopData = $oferta->modulos->sortBy('n_modulo'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="module-item">
                                        <div class="module-num"><?php echo e(str_pad($modulo->n_modulo, 2, '0', STR_PAD_LEFT)); ?>

                                        </div>
                                        <div class="module-body">
                                            <div class="module-name"><?php echo e($modulo->nombre); ?></div>
                                            <div class="module-info"></div>
                                            <?php if($modulo->docente && $modulo->docente->persona): ?>
                                                <div class="module-docente">
                                                    <i class="fas fa-chalkboard-teacher"></i>
                                                    <?php echo e($modulo->docente->persona->nombres); ?>

                                                    <?php echo e($modulo->docente->persona->apellido_paterno); ?>

                                                    <?php echo e($modulo->docente->persona->apellido_materno); ?>
                    ...
                    <?php if(optional($oferta->posgrado)->creditaje ||
                        ...
                        <div class="section-block">
                            ...
                            <div
                                ...
                                <?php if(optional($oferta->posgrado)->creditaje): ?>
                                    <div
                                        ...
                                        <div
                                            ...
                                            <?php echo e($oferta->posgrado->creditaje); ?>
                                ...
                                <?php if(optional($oferta->posgrado)->carga_horaria): ?>
                                    <div
                                        style="background:rgba(252,123,4,.06);border:1px solid rgba(252,123,4,.15);border-radius:10px;padding:1rem;text-align:center">
                                        <div
                                            style="font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:800;color:var(--or1);line-height:1">
                                            <?php echo e($oferta->posgrado->carga_horaria); ?>h
                                        </div>
                                        <div
                                            style="font-size:.72rem;color:var(--t-muted);text-transform:uppercase;letter-spacing:.06em;margin-top:.2rem">
                                            Carga Horaria</div>
                                ...
                                <?php if($oferta->cantidad_sesiones): ?>
                                    <div
                                        style="background:rgba(252,123,4,.06);border:1px solid rgba(252,123,4,.15);border-radius:10px;padding:1rem;text-align:center">
                                        <div
                                            style="font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:800;color:var(--or1);line-height:1">
                                            <?php echo e($oferta->cantidad_sesiones); ?>
                                ...
                                <?php if($oferta->gestion): ?>
                                    <div
                                        style="background:rgba(252,123,4,.06);border:1px solid rgba(252,123,4,.15);border-radius:10px;padding:1rem;text-align:center">
                                        <div
                                            style="font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:800;color:var(--or1);line-height:1">
                                            <?php echo e($oferta->gestion); ?>
                ...
                <aside class="right-col">
                    ...
                    <div class="sidebar-card" id="planes">
                        ...
                        <?php if($precioTotal > 0): ?>
                            ...
                            <div class="price-main" id="price-main-display">Bs. <?php echo e(number_format($precioTotalMostrar, 0, ',', '.')); ?></div>
                        ...
                        <?php if($planesPago->isNotEmpty()): ?>
                            <div class="plan-tabs">
                                <?php $__currentLoopData = $planesPago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planNombre => $conceptos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="plan-tab <?php echo e($loop->first ? 'active' : ''); ?>"
                                        onclick="switchPlan('<?php echo e(Str::slug($planNombre)); ?>', this)">
                            ...
                            <?php $__currentLoopData = $planesPago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planNombre => $conceptos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $totalPlan = $conceptos->sum('pago_bs'); ?>
                                <div class="plan-detail <?php echo e($loop->first ? 'active' : ''); ?>"
                                    id="plan-<?php echo e(Str::slug($planNombre)); ?>"
                                    data-plan-price="<?php echo e($totalPlan); ?>">
                                    <?php $__currentLoopData = $conceptos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="concept-row">
                                            <div class="concept-name">
                                                <?php echo e(optional($pc->concepto)->nombre ?? 'Concepto'); ?></div>
                                            <div style="text-align:right">
                                                <div class="concept-val">Bs.
                                                    <?php echo e(number_format($pc->pago_bs, 0, ',', '.')); ?></div>
                                                <?php if($pc->n_cuotas && $pc->n_cuotas > 1): ?>
                                                    <span class="concept-cuotas">en <?php echo e($pc->n_cuotas); ?> cuotas</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($totalPlan > 0): ?>
                                        <div class="concept-row" style="border-top:1px solid rgba(252,123,4,.25);margin-top:.5rem;padding-top:.5rem;font-weight:700;">
                                            ...
                                            <div style="text-align:right">
                                                <div class="concept-val" style="color:var(--or1);">Bs. <?php echo e(number_format($totalPlan, 0, ',', '.')); ?></div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="sidebar-cta">
                            ...
                            <a href="https://wa.me/591000000000?text=Hola,%20estoy%20interesado%20en%20el%20programa%20<?php echo e(urlencode(optional($oferta->posgrado)->nombre ?? '')); ?>"
                        ...
                        <div class="info-rows">
                            ...
                            <?php if($oferta->modalidad): ?>
                                <div class="info-row">
                                    ...
                                    <div class="info-val"><?php echo e($oferta->modalidad->nombre); ?></div>
                                </div>
                            <?php endif; ?>

                            <?php if(optional($oferta->posgrado)->area): ?>
                                <div class="info-row">
                                    <div class="info-key"><i class="fas fa-tag"></i> Área</div>
                                    <div class="info-val"><?php echo e($oferta->posgrado->area->nombre); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if(isset($oferta->posgrado->duracion_numero) && isset($oferta->posgrado->duracion_unidad)): ?>
                                <div class="info-row">
                                    ...
                                    <div class="info-val"><?php echo e($oferta->posgrado->duracion_numero); ?>

                                        <?php echo e($oferta->posgrado->duracion_unidad); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($oferta->n_modulos): ?>
                                <div class="info-row">
                                    ...
                                    <div class="info-val"><?php echo e($oferta->n_modulos); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($oferta->fecha_inicio_programa): ?>
                                <div class="info-row">
                                    ...
                                    <div class="info-val"><?php echo e(\Carbon\Carbon::parse($oferta->fecha_inicio_programa)->locale('es')->translatedFormat('d M, Y')); ?></div>
                                </div>
                            <?php endif; ?>
    ...
    <!-- ═══════════════ RELATED ═══════════════ -->
    <?php if($relacionadas->isNotEmpty()): ?>
        <section class="related-section">
            <div class="container">
                ...
                <div class="related-grid">
                    <?php $__currentLoopData = $relacionadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $relPlan =
                        ...
                        <div class="rel-card">
                            <div class="rel-img">
                                <?php if($rel->portada): ?>
                                    <img src="<?php echo e(asset($rel->portada)); ?>"
                                        alt="<?php echo e(optional($rel->posgrado)->nombre); ?>"
                                        onerror="this.src='https://placehold.co/600x300/2e1600/fc7b04?text=Programa'">
                                <?php else: ?>
                                    <img src="https://placehold.co/600x300/2e1600/fc7b04?text=<?php echo e(urlencode(optional(optional($rel->posgrado)->tipo)->nombre ?? 'Programa')); ?>"
                                        alt="<?php echo e(optional($rel->posgrado)->nombre); ?>">
                                <?php endif; ?>
                                <?php if(optional(optional($rel->posgrado)->tipo)->nombre): ?>
                                    <span class="rel-type"><?php echo e($rel->posgrado->tipo->nombre); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="rel-body">
                                <?php if(optional($rel->sucursal)->nombre): ?>
                                    <div class="rel-sede"><i class="fas fa-map-marker-alt"></i>
                                        <?php echo e($rel->sucursal->nombre); ?></div>
                                <?php endif; ?>
                                <div class="rel-name"><?php echo e(optional($rel->posgrado)->nombre ?? 'Programa'); ?></div>
                                <div class="rel-footer">
                                    <div class="rel-price">
                                        <?php if($relPrecio): ?>
                                            Bs. <?php echo e(number_format($relPrecio, 0, ',', '.')); ?>
                                    ...
                                    <a href="<?php echo e(route('oferta.detalle', $rel->id)); ?>" class="rel-btn">
        ...
        <div class="container">
            <div class="mini-footer-inner">
                ...
                <div style="display:flex;gap:1.2rem;align-items:center">
                    ...
                    <a href="<?php echo e(route('catalogo')); ?>">Catálogo</a>
                    <a href="<?php echo e(route('welcome')); ?>#contacto">Contacto</a>
                </div>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/oferta-detalle.blade.php ENDPATH**/ ?>