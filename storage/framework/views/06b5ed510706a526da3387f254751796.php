    ...
    <?php if($inscripciones->count() > 0): ?>
        ...
        <div class="acad-nav-wrap">
            <?php $__currentLoopData = $inscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button"
                    class="acad-nav-btn <?php echo e($key == 0 ? 'active' : ''); ?>"
                    data-target="acad-panel-<?php echo e($key); ?>"
        ...
        <?php $__currentLoopData = $inscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="acad-panel <?php echo e($key == 0 ? 'active' : ''); ?>" id="acad-panel-<?php echo e($key); ?>">
                    ...
                    <div class="acad-hero-left">
                        ...
                        <div class="acad-hero-text">
                            <div class="acad-hero-title">
                                <?php echo e($oferta?->posgrado?->nombre ?? 'Oferta #' . $ins->ofertas_academica_id); ?>

                            </div>
                            <div class="acad-hero-chips">
                                <?php if($oferta?->codigo): ?>
                                    <span class="acad-code-chip"><?php echo e($oferta->codigo); ?></span>
                                <?php endif; ?>
                                <span class="acad-estado-chip <?php echo e($ins->estado == 'Inscrito' ? 'acad-chip-inscrito' : 'acad-chip-preinscrito'); ?>">
                                    <i class="<?php echo e($ins->estado == 'Inscrito' ? 'ri-user-check-line' : 'ri-user-add-line'); ?>"></i>
                                    <?php echo e($ins->estado); ?>
                    ...
                    <div class="acad-hero-stats">
                        <div class="acad-stat">
                            ...
                            <div class="acad-stat-body">
                                ...
                                <span class="acad-stat-val"><?php echo e($fechaInicio); ?></span>
                            </div>
                        </div>
                        <div class="acad-stat">
                            ...
                            <div class="acad-stat-body">
                                ...
                                <span class="acad-stat-val"><?php echo e($fechaFin); ?></span>
                            </div>
                        </div>
                        <div class="acad-stat">
                            ...
                            <div class="acad-stat-body">
                                ...
                                <span class="acad-stat-val"><?php echo e($ins->planesPago?->nombre ?? '—'); ?></span>
                            </div>
                        </div>
                        <div class="acad-stat">
                            ...
                            <div class="acad-stat-body">
                                ...
                                <span class="acad-stat-val"><?php echo e($fechaReg); ?></span>
                            </div>
                        </div>
                        <?php if($ins->trabajador_cargo?->cargo?->nombre): ?>
                        <div class="acad-stat">
                            ...
                            <div class="acad-stat-body">
                                ...
                                <span class="acad-stat-val">
                                    <?php echo e($ins->trabajador_cargo->cargo->nombre); ?>

                                    <?php if($ins->trabajador_cargo?->sucursale?->sede?->nombre): ?>
                                        · <?php echo e($ins->trabajador_cargo->sucursale->sede->nombre); ?>
                ...
                <div class="acad-mods-section">
                    <div class="acad-mods-hdr">
                        ...
                        <span class="acad-mods-count"><?php echo e($totalMods); ?></span>
                    </div>

                    <?php if($matriculas && $totalMods > 0): ?>
                        <div class="acad-table-wrap">
                            <table class="acad-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $matriculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $matricula): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        ?>
                                        <tr style="animation-delay:<?php echo e($index * 0.04); ?>s">
                                            <td class="td-num"><?php echo e($index + 1); ?></td>

                                            
                                            <td>
                                                <div class="acad-mod-col">
                                                    <?php if($moodleVinculado): ?>
                                                        <a href="<?php echo e(config('moodle.url')); ?>/course/view.php?id=<?php echo e($modulo->moodle_course_id); ?>"
                                                           target="_blank"
                                                           class="acad-mod-link"
                                                    ...
                                                    <?php else: ?>
                                                        <span class="acad-mod-name <?php echo e($modulo ? '' : 'muted'); ?>">
                                                ...
                                                <?php if($docente): ?>
                                                    <div class="acad-doc-cell">
                                                        <div class="acad-doc-av">
                                                            <?php echo e(strtoupper(substr($docente->persona->nombres ?? 'D', 0, 1))); ?>

                                                        </div>
                                                        <span class="acad-doc-name">
                                                            <?php echo e($docente->persona->nombres ?? ''); ?>

                                                            <?php echo e($docente->persona->apellido_paterno ?? ''); ?>

                                                            <?php if($docenteMoodle): ?>
                                            ...
                                            <td>
                                                <span class="acad-pill <?php echo e($pillClass); ?>">
                                            ...
                                            <td>
                                                <div class="acad-moo-cell">
                                                    <?php if($moodleVinculado && $tieneMatricMoodle): ?>
                                                        <?php if($accesoSuspendido): ?>
                                                            <span class="acad-moo-block"><i class="ri-lock-fill"></i> Bloqueado</span>
                                                            <button type="button"
                                                                class="acad-btn-enable btn-est-moodle-toggle"
                                                                data-mod="<?php echo e($modulo->id); ?>"
                                                                data-ins="<?php echo e($ins->id); ?>"
                                                                data-nombre="<?php echo e(addslashes($modulo->nombre)); ?>"
                                                                data-sus="0">
                                            ...
                                            <td style="text-align:center;">
                                                <?php if($oferta): ?>
                                                    <a href="<?php echo e(route('admin.posgrads.ofertas.detalle', $oferta->id)); ?>"
                                                       class="acad-eye-btn"
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/estudiantes/partials/tab-academico.blade.php ENDPATH**/ ?>