...
<?php $__env->startSection('title', 'Detalle del Módulo - ' . ($modulo->nombre ?? '')); ?>

<?php $__env->startSection('css'); ?>
<?php echo $__env->make('admin.ofertas-academicas.partials.modulo-detalle-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="mdh-left">
                ...
                <div class="mdh-text-block">
                    ...
                    <div class="modulo-badge-display">
                        <span class="color-dot" style="background: <?php echo e($modulo->color ?? '#fc7b04'); ?>;"></span>
                        <span class="modulo-nombre-display"><?php echo e($modulo->nombre ?? 'Sin nombre'); ?></span>
                    </div>
                </div>
            </div>
            <a href="<?php echo e(route('admin.posgrads.ofertas.detalle', $ofertaId)); ?>" class="mdh-btn-back">
...
<div class="container-fluid">
    <div class="info-grid">
        <div class="info-card">
            ...
            <div class="value"><?php echo e($modulo->n_modulo ?? '—'); ?></div>
        </div>
        <div class="info-card">
            <label><i class="ri-user-line"></i> Docente</label>
            <div class="value">
                <?php if($modulo->docente && $modulo->docente->persona): ?>
                    <?php echo e($modulo->docente->persona->nombres ?? ''); ?> <?php echo e($modulo->docente->persona->apellido_paterno ?? ''); ?> <?php echo e($modulo->docente->persona->apellido_materno ?? ''); ?>
        ...
        <div class="info-card">
            ...
            <div class="value"><?php echo e($modulo->fecha_inicio ? \Carbon\Carbon::parse($modulo->fecha_inicio)->format('d/m/Y') : '—'); ?></div>
        </div>
        <div class="info-card">
            <label><i class="ri-calendar-check-line"></i> Fecha Fin</label>
            <div class="value"><?php echo e($modulo->fecha_fin ? \Carbon\Carbon::parse($modulo->fecha_fin)->format('d/m/Y') : '—'); ?></div>
        </div>
    </div>
                ...
                <div class="tab-pane active" id="tab-matriculaciones">
                    <div class="tab-actions">
                        ...
                        <div class="tab-actions-buttons">
                            ...
                            <button class="btn-matricular-moodle" id="btnMatricularTodosMoodle" data-modulo-id="<?php echo e($modulo->id); ?>">
                    ...
                    <div class="academico-tbl-wrap">
                        <table class="table-matriculas" style="width:100%;border-collapse:collapse;">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $inscritos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $inscrito): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="transition:background .1s;border-bottom:1px solid #e9ecef;">
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;text-align:center;"><?php echo e($i + 1); ?></td>
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;"><strong class="estudiante-nombre"><?php echo e($inscrito['estudiante_nombre']); ?></strong></td>
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;"><?php echo e($inscrito['estudiante_ci']); ?></td>
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;"><?php echo e($inscrito['celular']); ?></td>
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;"><?php echo e($inscrito['correo']); ?></td>
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;">
                                        <?php if($inscrito['matriculado']): ?>
                                    ...
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;">
                                        ...
                                        <?php elseif($inscrito['acceso_suspendido']): ?>
                                    ...
                                    <td style="padding:.7rem .5rem;font-size:.85rem;color:#495057;">
                                        <?php if($inscrito['tiene_cuenta_moodle']): ?>
                                            <span style="display:inline-flex;align-items:center;gap:.35rem;padding:.25rem .6rem;border-radius:6px;font-size:.75rem;font-weight:600;background:rgba(34,197,94,.1);color:#16a34a;">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div style="margin-top:.4rem;padding:.4rem .55rem;background:#fff7ed;border:1px solid #fed7aa;border-radius:6px;font-size:.7rem;color:#9a3412;line-height:1.5;display:flex;align-items:flex-start;gap:.3rem;max-width:260px;">
                                                ...
                                                <span>Debe ir a <a href="<?php echo e($routeInscripciones); ?>" style="color:#c96004;font-weight:700;text-decoration:underline;">Inscripciones de la oferta</a> para crear la cuenta de usuario.</span>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    <td style="padding:.7rem .5rem;text-align:center;">
                                        <?php if($modulo->moodle_course_id): ?>
                                            <?php if($inscrito['acceso_suspendido']): ?>
                                                <button type="button" class="btn-activar btn-toggle-acceso"
                                                    ...
                                                    data-suspender="0"
                                                    data-inscripcion-id="<?php echo e($inscrito['id']); ?>"
                                                    data-modulo-id="<?php echo e($modulo->id); ?>">
                                                    <i class="ri-play-circle-line"></i> Reactivar
                                                </button>
                                            <?php elseif(!$inscrito['en_moodle']): ?>
                                                <?php if($inscrito['tiene_cuenta_moodle']): ?>
                ...
                <div class="tab-pane" id="tab-academico">
                    ...
                    <div class="academico-summary">
                        <div class="academico-summary-card">
                            ...
                            <div>
                                <div class="academico-summary-val"><?php echo e($totalEst); ?></div>
                        ...
                        <div class="academico-summary-card">
                            ...
                            <div>
                                <div class="academico-summary-val"><?php echo e($conEstudios); ?></div>
                        ...
                        <div class="academico-summary-card">
                            ...
                            <div>
                                <div class="academico-summary-val"><?php echo e($conPlan); ?></div>
                        ...
                        <div class="academico-summary-card">
                            ...
                            <div>
                                <div class="academico-summary-val"><?php echo e($conCelular); ?></div>
                    ...
                    <div class="academico-tbl-wrap">
                        <table class="academico-tbl">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $inscritos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $inscrito): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td style="text-align:center;color:#94a3b8;font-size:.78rem;"><?php echo e($index + 1); ?></td>
                                    <td>
                                        <div class="academico-name">
                                            <span class="academico-avatar">
                                                <?php echo e(Str::upper(substr($inscrito['nombres'], 0, 1))); ?><?php echo e(Str::upper(substr($inscrito['apellido_paterno'], 0, 1))); ?>

                                            </span>
                                            <div>
                                                <div class="academico-name-text">
                                                    <?php echo e(trim(($inscrito['apellido_paterno'] ?? '') . ' ' . ($inscrito['apellido_materno'] ?? '') . ' ' . ($inscrito['nombres'] ?? '')) ?: '—'); ?>

                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="academico-ci"><i class="ri-fingerprint-line"></i><?php echo e($inscrito['estudiante_ci']); ?></span></td>
                                    <td>
                                        <div class="academico-contact">
                                            <?php if($inscrito['celular'] && $inscrito['celular'] !== '—'): ?>
                                            <span class="academico-contact-item"><i class="ri-phone-line"></i><?php echo e($inscrito['celular']); ?></span>
                                            <?php endif; ?>
                                            <?php if($inscrito['correo'] && $inscrito['correo'] !== '—'): ?>
                                            <span class="academico-contact-item"><i class="ri-mail-line"></i><?php echo e($inscrito['correo']); ?></span>
                                            <?php endif; ?>
                                            <?php if((!$inscrito['celular'] || $inscrito['celular'] === '—') && (!$inscrito['correo'] || $inscrito['correo'] === '—')): ?>
                                            <span style="color:#94a3b8;font-size:.78rem;">—</span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($inscrito['plan_pago'] !== '—'): ?>
                                            <span class="academico-plan"><i class="ri-funds-box-line"></i><?php echo e($inscrito['plan_pago']); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(count($estudios) > 0): ?>
                                            ...
                                            <div style="display:flex;flex-direction:column;gap:2px;font-size:.78rem;line-height:1.4;">
                                                <?php if($principal['grado']): ?>
                                                <span style="display:inline-flex;align-items:center;gap:4px;color:#9a4904;font-weight:600;">
                                                    <i class="ri-graduation-cap-line" style="font-size:.7rem;"></i><?php echo e($principal['grado']); ?>

                                                </span>
                                                <?php endif; ?>
                                                <?php if($principal['universidad']): ?>
                                                <span style="display:inline-flex;align-items:center;gap:4px;color:#64748b;">
                                                    <i class="ri-building-line" style="font-size:.7rem;"></i><?php echo e($principal['universidad']); ?>

                                                </span>
                                                <?php endif; ?>
                                                <?php if($principal['profesion']): ?>
                                                <span style="display:inline-flex;align-items:center;gap:4px;color:#475569;font-weight:500;">
                                                    <i class="ri-briefcase-line" style="font-size:.7rem;"></i><?php echo e($principal['profesion']); ?>
                                                ...
                                                <span style="margin-top:2px;background:#fc7b04;color:#fff;border-radius:10px;padding:0 7px;font-size:.65rem;font-weight:700;display:inline-flex;align-items:center;width:fit-content;height:18px;">
                                                    +<?php echo e(count($estudios) - 1); ?> más
                                                </span>
                                                <?php endif; ?>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td style="text-align:center;">
                                        <a href="<?php echo e(route('admin.estudiantes.verDetalle', $inscrito['estudiante_id'])); ?>"
                ...
                <div class="tab-pane" id="tab-actividades">
                    <div class="act-header">
                        ...
                        <div style="display:flex;gap:0.5rem;align-items:center;flex-wrap:wrap;">
                            <?php if($modulo->moodle_course_id): ?>
                            <a href="<?php echo e(rtrim(config('moodle.url'),'/')); ?>/course/view.php?id=<?php echo e($modulo->moodle_course_id); ?>"
                    ...
                    <div class="toolbar-editor" id="toolbarEditor" style="<?php echo e($modulo->moodle_course_id ? '' : 'display:none;'); ?>">
                    ...
                    <div id="actividadesEditorData" data-modulo-id="<?php echo e($modulo->id); ?>" data-course-id="<?php echo e($modulo->moodle_course_id ?? 0); ?>" data-api-base="/admin/posgrads/modulos" style="display:none;"></div>
                ...
                <div class="tab-pane" id="tab-centralizador">
                    <div class="libro-header">
                        ...
                        <div style="display:flex;gap:.5rem;align-items:center;flex-wrap:wrap;">
                            <button class="btn-cargar-libro" id="btnCargarCentralizador" data-modulo-id="<?php echo e($modulo->id); ?>">
                            ...
                            <a href="/admin/posgrads/modulos/<?php echo e($modulo->id); ?>/reporte/notas-detallado" id="btnReporteDetallado" target="_blank" style="display:none;align-items:center;gap:.4rem;padding:.35rem .85rem;border-radius:7px;font-size:.8rem;font-weight:600;background:rgba(99,102,241,.12);border:1px solid rgba(99,102,241,.4);color:#4338ca;text-decoration:none;cursor:pointer;" title="Generar PDF con notas por actividad">
                                <i class="ri-file-chart-line"></i> Reporte Detallado
                            </a>
                            <a href="/admin/posgrads/modulos/<?php echo e($modulo->id); ?>/reporte/notas-finales" id="btnReporteFinales" target="_blank" style="display:none;align-items:center;gap:.4rem;padding:.35rem .85rem;border-radius:7px;font-size:.8rem;font-weight:600;background:rgba(22,163,74,.1);border:1px solid rgba(22,163,74,.4);color:#15803d;text-decoration:none;cursor:pointer;" title="Generar PDF con nota final y en literal">
...
<script src="<?php echo e(URL::asset('build/js/actividades-editor.js')); ?>"></script>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/ofertas-academicas/modulo-detalle.blade.php ENDPATH**/ ?>