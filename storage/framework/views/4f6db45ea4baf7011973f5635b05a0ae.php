            ...
            <div class="dph-inner">
                <div class="dph-left">
                    ...
                    <div class="dph-text-block">
                        <h1 class="dph-title">Áreas</h1>
                        <p class="dph-desc">Gestión y administración de áreas académicas</p>
                    </div>
                </div>
                <div class="dph-right">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="ri-add-circle-line"></i> Nueva Área
                    </h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-1">
                            <label for="nombreCrear" class="form-label">
                                <i class="ri-layout-grid-line" style="color:#fc7b04;"></i>
                                Nombre del Área <span class="req">*</span>
                            </label>
                            <div class="field-wrapper">
                                <input type="text" class="form-control" id="nombreCrear"
                                    placeholder="Ej: Ingeniería, Salud, Ciencias…" maxlength="100" autocomplete="off">
    ...
    <div class="modal fade" id="modalEditar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:460px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="ri-edit-2-line"></i> Editar Área
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="delete-warning-box">
                        ...
                        <p class="delete-msg-primary">¿Eliminar área?</p>
        ...
        (function() {
            ...
            function initDataTable() {
                tabla = $('#tabla-areas').DataTable({
                    ajax: {
                        url: '<?php echo e(route('admin.areas.listar')); ?>',
                        dataSrc: 'data'
                    },
                    ordering: true,
                    paging: false,
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: d =>
                                ...
                                '" title="Editar área"><i class="ri-pencil-fill"></i></button>' +
                                '<button class="btn btn-action btn-action-delete btn-accion-eliminar" data-id="' +
                                d.id + '" data-nombre="' + escHtml(d.nombre) +
                                '" title="Eliminar área"><i class="ri-delete-bin-fill"></i></button>' +
                                '</div>'
                        }
                    ],
                    language: {
            ...
            function bindEvents() {
                ...
                $('#btnConfirmarEliminar').on('click', function() {
                    ...
                    console.log('Confirm delete for ID:', idEliminar);
                    eliminarArea(idEliminar);
                });
            ...
            function validar(inputId, iconId, fbId) {
                ...
                if (!val) return setError('El nombre del área es obligatorio.');
                ...
                if (!/^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s\-']+$/.test(val)) return setError(
            ...
            function verificarNombre(inputId, iconId, fbId, idArea, btnId) {
                ...
                $.ajax({
                    url: '<?php echo e(route('admin.areas.verificar')); ?>',
                    type: 'POST',
                    data: {
                        _token: CSRF,
                        nombre: val,
                    ...
                    success: function(r) {
                        if (r.existe) {
                            ...
                            icon.innerHTML = '<i class="ri-close-circle-fill"></i>';
                            fb.className = 'field-feedback error';
                            fb.innerHTML = '<i class="ri-error-warning-line"></i>Esta área ya existe.';
                            $(btnId).prop('disabled', true);
                        } else {
                            input.classList.remove('is-invalid');
                            input.classList.add('is-valid');
            ...
            function actualizar() {
                ...
                $.ajax({
                    ...
                    .done(r => {
                        ...
                        tabla.ajax.reload();
                        toast('success', r.message || 'Área actualizada correctamente.');
                    })
                    .fail(xhr => {
                        console.log('Update error:', xhr);
                        handleAjaxError(xhr, 'nombreEditar', 'iconEditar', 'fbEditar', 'actualizar');
                    })
            ...
            function eliminarArea(id) {
                ...
                $.ajax({
                    ...
                    .done(r => {
                        ...
                        tabla.ajax.reload();
                        toast('success', r.message || 'Área eliminada correctamente.');
                    })
                    .fail(xhr => {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/areas/index.blade.php ENDPATH**/ ?>