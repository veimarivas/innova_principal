...
<?php $__env->startSection('title', 'Dashboard - Ranking de Inscripciones'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-page">
        ...
        <div class="dashboard-header">
            <div>
                ...
                <div class="breadcrumb-custom mt-2">
                    <a href="<?php echo e(url('/admin/dashboard')); ?>">Inicio</a>
                ...
                <div class="filter-bar-row">
                    <div class="filter-group">
                        ...
                        <select name="mes" id="mes" class="filter-select">
                            <?php $__currentLoopData = $mesesEs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $nombreMesEs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($idx + 1); ?>" <?php echo e($idx + 1 == $mes ? 'selected' : ''); ?>>
                                    <?php echo e($nombreMesEs); ?>
                    ...
                    <div class="filter-group">
                        ...
                        <select name="gestion" id="gestion" class="filter-select">
                            <?php for($g = date('Y'); $g >= 2020; $g--): ?>
                                <option value="<?php echo e($g); ?>" <?php echo e($g == $gestion ? 'selected' : ''); ?>>
                                    <?php echo e($g); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    <div class="filter-group">
                        ...
                        <select name="sucursal" id="sucursal" class="filter-select">
                            ...
                            <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sucursal->id); ?>" <?php echo e($sucursal->id == $sucursalId ? 'selected' : ''); ?>>
                    ...
                    <div style="display:flex; gap:8px; align-items:flex-end;">
                        ...
                        <button type="button" id="resetFilters" class="btn-reset-filters" title="Restablecer filtros"
                            data-mes="<?php echo e($mesActualDefault); ?>" data-gestion="<?php echo e($gestionActualDefault); ?>">
        ...
        <div id="rankingTitleBar" class="d-flex align-items-center gap-3 mb-4 px-1"
            ...
            <div style="position: relative;">
                <h5 id="rankingTitle"
                    ...
                    Ranking — <span id="rankingPeriodText"><?php echo e($nombreMes); ?> <?php echo e($gestion); ?></span>
                </h5>
            ...
            <span id="rankingPeriodBadge" class="period-badge ms-auto"
                ...
                <i class="ri-calendar-check-line"></i> <?php echo e($nombreMes); ?> <?php echo e($gestion); ?>
        ...
        <div id="top3-and-chart-section">
            <?php if($rankingGeneralTop3->isEmpty()): ?>
                            ...
                            <div class="row align-items-end justify-content-center g-4">
                                ...
                                <div class="col-md-4">
                                    <div class="podium-place podium-second h-100 d-flex flex-column justify-content-end">
                                        <div class="podium-card">
                                            <a href="<?php echo e(route('admin.vendedor.inscripciones', ['personaId' => $rankingGeneralTop3[1]->id ?? 0])); ?>"
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <div class="position-relative d-inline-block mb-2">
                                                            <?php if(isset($rankingGeneralTop3[1]) &&
                                                                    $rankingGeneralTop3[1]->fotografia &&
                                                                    file_exists(public_path($rankingGeneralTop3[1]->fotografia))): ?>
                                                                <img src="<?php echo e(asset($rankingGeneralTop3[1]->fotografia)); ?>"
                                                        ...
                                                        <?php if(isset($rankingGeneralTop3[1])): ?>
                                                            <h6 class="mb-1 fw-bold">
                                                                <?php echo e($rankingGeneralTop3[1]->nombre_completo ?? ''); ?></h6>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <p class="text-muted small mb-0 mt-2">
                                                            <?php echo e($rankingGeneralTop3[1]->total_inscripciones ?? 0); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="podium-place podium-first h-100 d-flex flex-column justify-content-end">
                                        <div class="podium-card">
                                            <a href="<?php echo e(route('admin.vendedor.inscripciones', ['personaId' => $rankingGeneralTop3[0]->id])); ?>"
                                                class="ranking-card d-block text-decoration-none text-dark podium-hover overflow-hidden"
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <div class="position-relative d-inline-block mb-2">
                                                            <?php if($rankingGeneralTop3[0]->fotografia && file_exists(public_path($rankingGeneralTop3[0]->fotografia))): ?>
                                                                <img src="<?php echo e(asset($rankingGeneralTop3[0]->fotografia)); ?>"
                                                        ...
                                                        <h5 class="mb-1 fw-bold">
                                                            <?php echo e($rankingGeneralTop3[0]->nombre_completo); ?></h5>
                                                    </div>
                                                    <div>
                                                        <div class="position-relative mt-2">
                                                            <div
                                                        ...
                                                        <p class="text-muted mb-0 mt-2">
                                                            <?php echo e($rankingGeneralTop3[0]->total_inscripciones); ?> inscripciones
                                                        </p>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                <div class="col-md-4">
                                    <div class="podium-place podium-third h-100 d-flex flex-column justify-content-end">
                                        <div class="podium-card">
                                            <a href="<?php echo e(route('admin.vendedor.inscripciones', ['personaId' => $rankingGeneralTop3[2]->id ?? 0])); ?>"
                                                class="ranking-card d-block text-decoration-none text-dark podium-hover overflow-hidden"
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <div class="position-relative d-inline-block mb-2">
                                                            <?php if(isset($rankingGeneralTop3[2]) &&
                                                                    $rankingGeneralTop3[2]->fotografia &&
                                                                    file_exists(public_path($rankingGeneralTop3[2]->fotografia))): ?>
                                                                <img src="<?php echo e(asset($rankingGeneralTop3[2]->fotografia)); ?>"
                                                        ...
                                                        <?php if(isset($rankingGeneralTop3[2])): ?>
                                                            <h6 class="mb-1 fw-bold">
                                                                <?php echo e($rankingGeneralTop3[2]->nombre_completo ?? ''); ?></h6>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div>
                                                        <div class="position-relative mt-2">
                                                        ...
                                                        <p class="text-muted small mb-0 mt-2">
                                                            <?php echo e($rankingGeneralTop3[2]->total_inscripciones ?? 0); ?>
                    ...
                    <div class="col-md-4">
                        <div class="chart-card h-100 d-flex flex-column">
                            <div class="chart-card-header">
                                ...
                                <small><?php echo e($nombreMes); ?> <?php echo e($gestion); ?></small>
                            </div>
        ...
        <div id="bar-chart-section">
            <?php if(!empty($graficoBarrasData['sucursales'])): ?>
        ...
        <div id="full-ranking-section">
            <div class="section-title-bar">
                <h5><i class="ri-trophy-line" style="color: var(--dash-primary); font-size: 1.2rem;"></i>Ranking General
                    con Desglose</h5>
                <span class="period-badge"><i class="ri-user-follow-line"></i> <?php echo e(count($rankingGeneralCompleto)); ?>
                ...
                <table class="dash-table">
                    <thead>
                        <tr>
                            ...
                            <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoNombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th><?php echo e($tipoNombre); ?></th>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $rankingGeneralCompleto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="<?php echo e($index < 3 ? 'top-' . ($index + 1) : ''); ?>">
                                <td class="align-middle text-center">
                                    <?php if($medalEmoji): ?>
                                        <span class="medal-emoji"><?php echo e($medalEmoji); ?></span>
                                    <?php else: ?>
                                        <span class="rank-num"><?php echo e($index + 1); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="align-middle">
                                    <a href="<?php echo e(route('admin.vendedor.inscripciones', ['personaId' => $persona->id])); ?>"
                                        class="person-info">
                                        <img src="<?php echo e($avatarUrl); ?>" alt="<?php echo e($persona->nombre_completo); ?>"
                                            class="person-avatar-sm">
                                        <span class="person-name"><?php echo e($persona->nombre_completo); ?></span>
                                    </a>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="total-count"><?php echo e($persona->total_inscripciones); ?></span>
                                </td>
                                <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoId => $tipoNombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td class="align-middle text-center">
                                        <span
                                            class="tipo-count<?php echo e(($persona->desglose[$tipoId] ?? 0) > 0 ? ' has-data' : ''); ?>">
                                            <?php echo e($persona->desglose[$tipoId] ?? 0); ?>
            ...
            <div class="table-card" style="margin-bottom: 0;">
                <div class="section-title-bar">
                    <h5><i class="ri-building-line" style="color: var(--dash-primary); font-size: 1.2rem;"></i>Ranking por
                        Sucursal</h5>
                    <span class="period-badge"><i class="ri-store-2-line"></i> <?php echo e($rankingPorSucursal->count()); ?>

                        sucursales</span>
                </div>
                <div style="padding: 20px;">
                    <?php if($rankingPorSucursal->isEmpty()): ?>
                        <div class="empty-state">
                            <i class="ri-emotion-sad-line"></i>
                            <p class="text-muted mt-3">No hay datos disponibles para mostrar en este período.</p>
                        </div>
                    <?php else: ?>
                        <?php $__currentLoopData = $rankingPorSucursal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursalNombre => $personas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="branch-table-container">
                                <div class="branch-header">
                                    <h6 class="mb-0"><i class="ri-map-pin-2-line me-2"></i><?php echo e($sucursalNombre); ?></h6>
                                    <span class="branch-count-badge"><?php echo e(count($personas)); ?> personas</span>
                                </div>
                                <div class="table-responsive">
                                    <table class="dash-table">
                                        <thead>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $persona): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $medalEmoji = match ($index) {
                                                        0 => '🥇',
                                                        1 => '🥈',
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="<?php echo e(route('admin.vendedor.inscripciones', ['personaId' => $persona->id])); ?>"
                                                            ...
                                                            <img src="<?php echo e($avatarUrl); ?>"
                                                                alt="<?php echo e($persona->nombre_completo); ?>"
                                                                class="person-avatar-sm">
                                                            <span
                                                                class="person-name"><?php echo e($persona->nombre_completo); ?></span>
                                                        </a>
                                                    </td>
                                                    <td class="align-middle">
                                                        <span
                                                            class="total-count"><?php echo e($persona->total_inscripciones); ?></span>
                                                    </td>
                                                    <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoNombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $val = $persona->desglose[$tipoNombre] ?? 0; ?>
                                                        <td class="align-middle text-center">
                                                            <span
                                                                class="tipo-count <?php echo e($val > 0 ? 'has-data' : ''); ?>"><?php echo e($val); ?></span>
                                                        </td>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getFiltersFromURL() {
                ...
                return {
                    mes: urlParams.get('mes') || <?php echo e(Carbon\Carbon::now()->month); ?>,
                    gestion: urlParams.get('gestion') || <?php echo e(Carbon\Carbon::now()->year); ?>,
            ...
            function updateDashboard(filters) {
                ...
                axios.get("<?php echo e(route('admin.dashboard.data')); ?>", {
                        params: filters
                    })
                    .then(response => {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>