<?php $__env->startSection('title', 'Cronograma General'); ?>
                ...
                <div class="crono-card">
                    <div class="crono-header">
                        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.posgrads.index')); ?>">Posgrados</a>
                                    </li>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/cronogramas/index.blade.php ENDPATH**/ ?>