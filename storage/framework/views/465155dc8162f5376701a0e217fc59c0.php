<?php $__env->startSection('title'); ?> Trabajadores <?php $__env->stopSection(); ?>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4 text-center">
                            ...
                            <div class="photo-upload-container" style="cursor:pointer;" onclick="document.getElementById('fotografiaRegistro').click()">
                                <img id="previewFotografiaRegistro" src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" 
...
(function () {
    ...
    function cargarSelectores() {
        $.getJSON('<?php echo e(route("admin.trabajadores.listarCargos")); ?>', function (r) {
            todosCargos = r.data;
            const opts = r.data.map(c => '<option value="' + c.id + '">' + esc(c.nombre) + '</option>').join('');
            $('#filterCargo').append(opts);
        });
        $.getJSON('<?php echo e(route("admin.trabajadores.listarSedes")); ?>', function (r) {
            todasSedes = r.data;
        });
        $.getJSON('<?php echo e(route("admin.trabajadores.listarDepartamentos")); ?>', function (r) {
            const opts = r.data.map(d => '<option value="' + d.id + '">' + esc(d.nombre) + '</option>').join('');
            $('#pDepto').append(opts);
            $('#rDepto').append(opts);
            $('#eDepto').append(opts);
        });
        $.getJSON('<?php echo e(route("admin.trabajadores.listarCiudades")); ?>', function (r) {
    ...
    function initDataTable() {
        tabla = $('#tabla-trabajadores').DataTable({
            ajax: { 
                url: '<?php echo e(route("admin.trabajadores.listar")); ?>', 
                dataSrc: 'data',
                data: function(d) {
    ...
    function bindEvents() {
        ...
        $(document).on('change', '.edit-cargo-sede', function () {
            ...
            $.post('<?php echo e(route("admin.trabajadores.listarSucursalesPorSede")); ?>', { _token: CSRF, sede_id: sedeId })
                .done(function (r) {
    ...
    function buscarPersona() {
        ...
        $.post('<?php echo e(route("admin.trabajadores.buscarCarnet")); ?>', { _token: CSRF, carnet: carnet })
            .done(function (r) {
                if (r.encontrado) {
    ...
    function confirmarAsignacion() {
        ...
        $.post('<?php echo e(route("admin.trabajadores.asignar")); ?>', {
            _token: CSRF,
    ...
    function abrirModalRegistro() {
        ...
        if (personaSeleccionada) {
            ...
            $.post('<?php echo e(route("admin.trabajadores.buscarCarnet")); ?>', { _token: CSRF, carnet: p.carnet })
                .done(function (r) {
                    if (r.ya_trabajador) {
    ...
    function guardarTrabajador() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.trabajadores.guardarPersona")); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false
    ...
    function guardarPersona() {
        ...
        $.post('<?php echo e(route("admin.trabajadores.guardarPersona")); ?>', {
            _token: CSRF,
...
/* ── EDITAR TRABAJADOR ── */
    function editarTrabajador(id) {
        ...
        $.get('<?php echo e(route("admin.trabajadores.obtener", ["id" => "__ID__"])); ?>'.replace('__ID__', id))
            .done(function (r) {
                const t = r.data;
                const p = t.persona;
                if (!p) {
...
setBtnLoading('#btnConfirmarEdicion', true, 'Guardando…');
        ...
        .done(function (r) {
            ...
            return $.post('<?php echo e(route("admin.trabajadores.actualizarCargos")); ?>', {
                _token: CSRF,
    ...
    function verificarCarnetPersona(val) {
        $.post('<?php echo e(route("admin.trabajadores.verificarCarnetPersona")); ?>', { _token: CSRF, carnet: val }, function (r) {
    ...
    function verificarCorreoPersona(val) {
        $.post('<?php echo e(route("admin.trabajadores.verificarCorreoPersona")); ?>', { _token: CSRF, correo: val }, function (r) {
    ...
    function verificarCarnetEditar(val) {
        $.post('<?php echo e(route("admin.trabajadores.verificarCarnetPersona")); ?>', { _token: CSRF, carnet: val, id: editPersonaId }, function (r) {
    ...
    function verificarCorreoEditar(val) {
        $.post('<?php echo e(route("admin.trabajadores.verificarCorreoPersona")); ?>', { _token: CSRF, correo: val, id: editPersonaId }, function (r) {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/admin/trabajadores/index.blade.php ENDPATH**/ ?>