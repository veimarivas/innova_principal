    ...
    <div class="dropdown sidebar-user m-1 rounded">
        <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown"
            ...
            <span class="d-flex align-items-center gap-2">
                ...
                <?php else: ?>
                    <img class="rounded header-profile-user" src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>"
                        alt="Header Avatar">
                    <span class="text-start">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            <!-- item-->
            <h6 class="dropdown-header">Welcome <?php echo e(Auth::check() ? Auth::user()->name : 'Invitado'); ?>!</h6>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- ========== DASHBOARD ========== -->
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" title="Dashboard"
                        class="nav-link <?php echo e(isRouteActive('admin.dashboard') ? 'active' : ''); ?>">
                        <i class="ri-dashboard-line"></i> <span>Dashboard</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo e(route('admin.cuentas-videollamada.index')); ?>" title="Cuentas Videollamada"
                        class="nav-link <?php echo e(isRouteActive('admin.cuentas-videollamada.') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(isMenuOpen(['admin.posgrads.', 'admin.ofertas.', 'admin.posgrads.cronograma', 'admin.sedes.']) ? 'active' : ''); ?>"
                        href="#sidebarAcademico" data-bs-toggle="collapse" role="button"
                        aria-expanded="<?php echo e(isMenuOpen(['admin.posgrads.', 'admin.ofertas.', 'admin.posgrads.cronograma', 'admin.sedes.']) ? 'true' : 'false'); ?>"
                        aria-controls="sidebarAcademico">
                        <i class="ri-book-open-line"></i> <span>Gestión Académica</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(isMenuOpen(['admin.posgrads.', 'admin.ofertas.', 'admin.posgrads.cronograma', 'admin.sedes.']) ? 'show' : ''); ?>"
                        id="sidebarAcademico">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.sedes.index')); ?>" title="Sedes"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.sedes.index' ? 'active' : ''); ?>">Sedes</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.posgrads.index')); ?>" title="Posgrados"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.posgrads.index' ? 'active' : ''); ?>">Posgrados</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.ofertas.index')); ?>" title="Todas las Ofertas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.ofertas.index' ? 'active' : ''); ?>">Todas
                                    las Ofertas</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.posgrads.cronograma.index')); ?>" title="Cronograma"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.posgrads.cronograma.index' ? 'active' : ''); ?>">Cronograma</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(isMenuOpen(['admin.grados-academicos.', 'admin.profesiones.', 'admin.universidades.', 'admin.areas.', 'admin.cuentas-videollamada.', 'admin.tipos.', 'admin.convenios.', 'admin.fases.', 'admin.modalidades.']) ? 'active' : ''); ?>"
                        href="#sidebarCatalogos" data-bs-toggle="collapse" role="button"
                        aria-expanded="<?php echo e(isMenuOpen(['admin.grados-academicos.', 'admin.profesiones.', 'admin.universidades.', 'admin.areas.', 'admin.cuentas-videollamada.', 'admin.tipos.', 'admin.convenios.', 'admin.fases.', 'admin.modalidades.']) ? 'true' : 'false'); ?>"
                        aria-controls="sidebarCatalogos">
                        <i class="ri-folder-2-line"></i> <span>Catálogos</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(isMenuOpen(['admin.grados-academicos.', 'admin.profesiones.', 'admin.universidades.', 'admin.areas.', 'admin.cuentas-videollamada.', 'admin.tipos.', 'admin.convenios.', 'admin.fases.', 'admin.modalidades.']) ? 'show' : ''); ?>"
                        id="sidebarCatalogos">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.grados-academicos.index')); ?>" title="Grados Académicos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.grados-academicos.index' ? 'active' : ''); ?>">Grados
                                    Académicos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.profesiones.index')); ?>" title="Profesiones"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.profesiones.index' ? 'active' : ''); ?>">Profesiones</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.universidades.index')); ?>" title="Universidades"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.universidades.index' ? 'active' : ''); ?>">Universidades</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.areas.index')); ?>" title="Áreas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.areas.index' ? 'active' : ''); ?>">Áreas</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.tipos.index')); ?>" title="Tipos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.tipos.index' ? 'active' : ''); ?>">Tipos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.convenios.index')); ?>" title="Convenios"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.convenios.index' ? 'active' : ''); ?>">Convenios</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.fases.index')); ?>" title="Fases"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.fases.index' ? 'active' : ''); ?>">Fases</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.modalidades.index')); ?>" title="Modalidades"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.modalidades.index' ? 'active' : ''); ?>">Modalidades</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(isMenuOpen(['admin.estudiantes.', 'admin.docentes.', 'admin.trabajadores.', 'admin.personas.', 'admin.cargos.', 'admin.users.']) ? 'active' : ''); ?>"
                        href="#sidebarRRHH" data-bs-toggle="collapse" role="button"
                        aria-expanded="<?php echo e(isMenuOpen(['admin.estudiantes.', 'admin.docentes.', 'admin.trabajadores.', 'admin.personas.', 'admin.cargos.', 'admin.users.']) ? 'true' : 'false'); ?>"
                        aria-controls="sidebarRRHH">
                        <i class="ri-user-settings-line"></i> <span>Gestión de Personas</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(isMenuOpen(['admin.estudiantes.', 'admin.docentes.', 'admin.trabajadores.', 'admin.personas.', 'admin.cargos.', 'admin.users.']) ? 'show' : ''); ?>"
                        id="sidebarRRHH">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.estudiantes.index')); ?>" title="Estudiantes"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.estudiantes.index' ? 'active' : ''); ?>">Estudiantes</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.docentes.index')); ?>" title="Docentes"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.docentes.index' ? 'active' : ''); ?>">Docentes</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.trabajadores.index')); ?>" title="Trabajadores"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.trabajadores.index' ? 'active' : ''); ?>">Trabajadores</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.personas.index')); ?>" title="Personas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.personas.index' ? 'active' : ''); ?>">Personas</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.cargos.index')); ?>" title="Cargos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.cargos.index' ? 'active' : ''); ?>">Cargos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.users.index')); ?>" title="Usuarios"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.users.index' ? 'active' : ''); ?>">Usuarios</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(isMenuOpen(['admin.conceptos.', 'admin.planes-pagos.', 'admin.contabilidad.', 'admin.comprobantes.', 'admin.bancos.', 'admin.cuentas-bancarias.', 'admin.cajas.', 'admin.estudiantes.']) ? 'active' : ''); ?>"
                        href="#sidebarContable" data-bs-toggle="collapse" role="button"
                        aria-expanded="<?php echo e(isMenuOpen(['admin.conceptos.', 'admin.planes-pagos.', 'admin.contabilidad.', 'admin.comprobantes.', 'admin.bancos.', 'admin.cuentas-bancarias.', 'admin.cajas.', 'admin.estudiantes.']) ? 'true' : 'false'); ?>"
                        aria-controls="sidebarContable">
                        <i class="ri-money-dollar-circle-line"></i> <span>Gestión Financiera</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(isMenuOpen(['admin.conceptos.', 'admin.planes-pagos.', 'admin.contabilidad.', 'admin.comprobantes.', 'admin.bancos.', 'admin.cuentas-bancarias.', 'admin.cajas.', 'admin.estudiantes.']) ? 'show' : ''); ?>"
                        id="sidebarContable">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.estudiantes.buscar')); ?>" title="Buscar Estudiante"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.estudiantes.buscar' ? 'active' : ''); ?>">Buscar
                                    Estudiante</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.conceptos.index')); ?>" title="Conceptos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.conceptos.index' ? 'active' : ''); ?>">Conceptos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contabilidad.dashboard')); ?>" title="Contabilidad"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.contabilidad.dashboard' ? 'active' : ''); ?>">Contabilidad</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.planes-pagos.index')); ?>" title="Planes de Pago"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.planes-pagos.index' ? 'active' : ''); ?>">Planes
                                    de Pago</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contabilidad.deudas-retrasadas')); ?>"
                                    title="Deudas Retrasadas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.contabilidad.deudas-retrasadas' ? 'active' : ''); ?>">Deudas
                                    Retrasadas</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contabilidad.cuotas-proximas')); ?>" title="Cuotas Próximas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.contabilidad.cuotas-proximas' ? 'active' : ''); ?>">Cuotas
                                    Próximas</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.contabilidad.recibos')); ?>" title="Recibos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.contabilidad.recibos' ? 'active' : ''); ?>">Recibos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.comprobantes.index')); ?>" title="Comprobantes de Pago"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.comprobantes.index' ? 'active' : ''); ?>">Comprobantes
                                    de Pago</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.bancos.index')); ?>" title="Bancos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.bancos.index' ? 'active' : ''); ?>">Bancos</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.cuentas-bancarias.index')); ?>" title="Cuentas Bancarias"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.cuentas-bancarias.index' ? 'active' : ''); ?>">Cuentas
                                    Bancarias</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.cajas.index')); ?>" title="Cajas"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.cajas.index' ? 'active' : ''); ?>">Cajas</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?php echo e(isMenuOpen(['admin.departamentos.', 'admin.sedes.', 'admin.fases.', 'admin.modalidades.']) ? 'active' : ''); ?>"
                        href="#sidebarConfig" data-bs-toggle="collapse" role="button"
                        aria-expanded="<?php echo e(isMenuOpen(['admin.departamentos.', 'admin.sedes.', 'admin.fases.', 'admin.modalidades.']) ? 'true' : 'false'); ?>"
                        aria-controls="sidebarConfig">
                        <i class="ri-map-pin-line"></i> <span>Ubicaciones</span>
                    </a>
                    <div class="collapse menu-dropdown <?php echo e(isMenuOpen(['admin.departamentos.', 'admin.sedes.', 'admin.fases.', 'admin.modalidades.']) ? 'show' : ''); ?>"
                        id="sidebarConfig">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.departamentos.index')); ?>" title="Departamentos"
                                    class="nav-link <?php echo e(Route::currentRouteName() === 'admin.departamentos.index' ? 'active' : ''); ?>">Departamentos</a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH C:\xampp_82_12\htdocs\innova-ciencia-virtual\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>